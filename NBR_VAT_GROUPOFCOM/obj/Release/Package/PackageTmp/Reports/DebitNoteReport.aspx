<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="DebitNoteReport.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.DebitNoteReport" %>
            ...
            <div class="panel panel-group">
                <div class="panel panel-primary panel-primary-custom">
                    <%--<div class="panel-heading" style="text-align: center; font-size: 18px; font-weight: bold; height: 25px; padding-top: 0px">ডেবিট নোট (মূসক-১২ক)</div>--%>
                     <div class="panel-heading" style="text-align: center; font-family:Tahoma; font-size:18px; font-weight: bold; height: 25px; padding-top: 0px">ডেবিট নোট (মূসক-৬.৮)</div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group form-group-sm">
                              ...
                              <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group form-group-sm">
                                            <label class="col-sm-5 control-label text-right">Debit Challan No :</label>
                                            <div class="col-sm-7">
                                                <asp:DropDownList runat="server" CssClass="form-control select2" ID="ddlChallanId" AutoPostBack="True" OnSelectedIndexChanged="ddlDebitChallanIndexChanged" />
                                            </div>
                                        </div>
                                    </div>
                                  <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div style="font-size: 16px">
                                       ...
                                       <p style="text-align: right; padding: 5px;">
                                                <b style="border: 1px solid gray; margin-right: 17px; margin-top: 20px;">মূসক-৬.৮</b>
                                        </p>
