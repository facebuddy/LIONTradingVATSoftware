...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="AboveTwoLacRep_6.10s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.AboveTwoLacRep_6__10s" %>
            ...
            <div class="col-sm-6">
               ...
               <div  class="col-sm-3" style="padding:0px; display:none;">
                 ...
                 <div class="col-sm-3">
                            ...
                            <asp:TextBox ID="precisionTxtBox" runat="server" placeholder="Precision" style="width:80px; display:none; "></asp:TextBox>
