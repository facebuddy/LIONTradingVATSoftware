<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="PurchaseRegister, App_Web_o1josinq" %>
...
<script type = "text/javascript">
    ...
    <script type = "text/javascript">
        function PrintPanelAll() {
            var panel = document.getElementById("<%=fullRecord.ClientID %>");
            var printWindow = window.open('', '', 'left=1,top=0,height=auto,width=auto,toolbar=0,scrollbars=1,status=0,dir=ltr');
            printWindow.document.write('<html><head><title>DIV Contents</title>');
            printWindow.document.write('<link rel="stylesheet" type="text/css" href="../Styles/bootstrap/bootstrap.css" />');
            printWindow.document.write('<link rel="stylesheet" type="text/css" href="../Styles/print.css" />');
  ...
  <div class="container-fluid">
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align:center; font-size:21px; font-weight:bold; height:30px; padding-top:0px">Purchase Register</div>
          <div class="panel-body" style="padding-top:0px; padding-bottom:0px">
            ...
            <div class="col-sm-4" style="padding:0px">
                 ...
                 <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-primary" onclick="btnSearch_Click" Text="Search" style="float:left;width:100px;margin-left:11%" />
            </div>    
            </div>
            <div class="row" style="margin-top:1%">
               <div class="col-sm-4">
               ...
               <div class="col-sm-4">
                    ...
                    <asp:Button ID="btnShow" runat="server" CssClass="btn btn-primary" onclick="btnShow_Click" Text="Show Report" style="float:left; margin-left:12%" />
               </div>
            </div>
        ...
        <div>
         <div id="bill" runat="server" Visible="false"  class="container-fluid" style="margin-top:2%;">
             ...
             <div class="row">
               <p>Item Name:<asp:Label runat="server" style="font-weight:bold" ID="lblPro"></asp:Label></p>
               <table class="table table-bordered" style="width:100%;background:none">
               <tr>
                   <td rowspan="2" style="text-align:center;width:1px;font-weight:bold">Serial No</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Purchase Type</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Receive Scroll No</td>
                   <td colspan="5" style="text-align:center;font-weight:bold">Local/Import </td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total VAT</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total SD</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total Price</td>
                  ...
                  <tr>
                    <td style="text-align:center;font-weight:bold">Ref.Challan No</td>
                    <td style="text-align:center;font-weight:bold">Purchase Date</td>
                    <td style="text-align:center;font-weight:bold">Saler Name</td>
                    <td style="text-align:center;font-weight:bold">Saler BIN</td>
            ...
            <asp:Button ID="btnPrintSingle" runat="server" Text="Print" CssClass="btn btn-default" style="float:right" onclientclick="return PrintPanelSingle();" Visible="false" />
            </div>
            <div id="fullRecord" runat="server" Visible="false"  class="container-fluid" style="margin-top:2%;">
             <div class="row">
             ...
             <div class="row">
               ...
               <tr>
                   ...
                   <td rowspan="2" style="text-align:center;font-weight:bold">Purchase Type</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Receive Scroll No</td>
                   <td colspan="6" style="text-align:center;font-weight:bold">Local/Import </td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total VAT</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total SD</td>
                   <td rowspan="2" style="text-align:center;font-weight:bold">Total Price</td>
                  </tr>
                  ...
                  <tr><asp:Label runat=server ID="fullRecordReport"></asp:Label></tr>
               </table>
             </div>
            </div>
            <asp:Button ID="btnPrintAll" runat="server" Text="Print" CssClass="btn btn-default" style="float:right" onclientclick="return PrintPanelAll();" Visible="false" />
