...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Sub_Form_CHA_Note57s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.Sub_Form_CHA_Note57s" %>
       ...
       <%--  <div class="gridDiv table-responsive paddingsmall">  
                               <asp:GridView ID="gvSubForm_CHA" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvSubForm_CHA_RowDataBound" ShowFooter="true" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="শাখা" DataField="branch_name"  FooterText="Total"/>
