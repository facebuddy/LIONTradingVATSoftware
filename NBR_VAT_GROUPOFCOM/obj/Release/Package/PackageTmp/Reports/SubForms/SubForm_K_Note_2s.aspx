...
<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" CodeBehind="SubForm_K_Note_2s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_K_Note_2s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              শূন্যহার বিশিষ্ট সরবরাহ প্রচ্ছন্ন রপ্তানি (নোট - ২) 
            </p>
            <hr />
        </div>
