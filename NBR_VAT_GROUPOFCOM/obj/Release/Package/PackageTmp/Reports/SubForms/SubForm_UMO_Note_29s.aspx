...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_UMO_Note_29s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_UMO_Note_29s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
           <p  class="printHeader" style="text-align: center;font-weight:bold;">
               প্রদত্ত সরবরাহ হইতে উৎসে কর্তনের জন্য (নোট-২৯)
            </p>
        </div>
                            ...
                            <div class="gridDiv table-responsive paddingsmall">  
                                <asp:GridView ID="gvSubForm_K" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvSubForm_K_RowDataBound" ShowFooter="true" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="ক্রেতা বিআইএন নম্বর" DataField="party_bin" />
                                        <asp:BoundField HeaderText="ক্রেতা নাম" DataField="party_name" />
                                        <asp:BoundField HeaderText="ক্রেতা ঠিকানা" DataField="party_address" FooterText="মোট" />
                                        ...
                                        <asp:BoundField HeaderText="ইনভয়েস নং (চালান পত্র/বিল নম্বর ইত্যাদি)" DataField="challan_no" DataFormatString="{0:#,#0.00}"/>
                                        <asp:BoundField HeaderText="ইনভয়েস/বিলের তারিখ" DataField="date_challan" />
                                        
                                        <asp:BoundField HeaderText="উৎসে কর্তন সার্টিফিকেট নং" DataField="vds_certificate_no" />
