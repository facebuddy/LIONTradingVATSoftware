<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_K_Note_7s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_K_Note_7s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
               আদর্শ করহার ব্যতীত ভিন্ন করহার ভিত্তিক পণ্য/সেবা (নোট-৭) 
            </p>
            <hr />
        </div>
                            ...
                            <div class="gridDiv table-responsive paddingsmall">  
                                <asp:GridView ID="gvSubForm_K" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvSubForm_K_RowDataBound" ShowFooter="true" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="মূল্য (ক)" DataField="price"   ItemStyle-HorizontalAlign="Right"/>
                                        <asp:BoundField HeaderText="সম্পূরক শুল্ক (খ)" DataField="sd"  ItemStyle-HorizontalAlign="Right"/>
                                       
                                        <asp:BoundField HeaderText="মূল্য সংযোজন কর (গ)" DataField="vat" ItemStyle-HorizontalAlign="Right"/>
