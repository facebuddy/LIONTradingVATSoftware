...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Details_Note_27s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.Details_Note_27s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
           <%-- <p class="printHeader" style="text-align: center;font-weight:bold;">Details of Note 27</p>--%>
             <p class="printHeader" style="text-align: center;font-weight:bold;">অন্যকোনো সমন্বয় (বৃদ্ধিকারী) (নোট-২৭)</p>
              <hr />
        </div>
