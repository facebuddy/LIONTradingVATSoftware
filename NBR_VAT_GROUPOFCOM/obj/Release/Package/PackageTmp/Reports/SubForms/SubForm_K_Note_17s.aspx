...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_K_Note_17s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_K_Note_17s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        ...
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              আদর্শ হারের ব্যতীত অন্যান্য হারে পণ্য/সেবা আমদানি (নোট-১৭)
            </p>
            <hr />
        </div>
                            ...
                            <div class="gridDiv table-responsive paddingsmall">  
                                <asp:GridView ID="gvSubForm_K" runat="server" AutoGenerateColumns="False"  OnRowDataBound="gvSubForm_K_RowDataBound" ShowFooter="true" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="মূল্য (ক)" DataField="total_price" DataFormatString="{0:#,#0.00}" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField HeaderText="সম্পূরক শুল্ক (খ)" DataField="purchase_sd"  DataFormatString="{0:#,#0.00}" ItemStyle-HorizontalAlign="Right"/>
                                        <asp:BoundField HeaderText="মূল্য সংযোজন কর (গ)" DataField="purchase_vat" DataFormatString="{0:#,#0.00}" ItemStyle-HorizontalAlign="Right" />
                                        ...
                                        <thead>
                                           <tr  style="border: 2px solid;">
                                               <%--<th>ক্রমিক নং</th>                                                
                                                ...
                                                <th>পণ্য/সেবার নাম</th>
                                                <th>এসেস্যাবল মূল্য </th>
                                                <th>ভ্যাট আরোপযোগ্যমূল্য</th>
                                                <th>সম্পূরক শুল্ক</th>                                               
                                                <th>মূসক</th>                                              
                                                <th>আগাম কর</th>
                                                <th style="min-width:60px;">মন্তব্য</th>
