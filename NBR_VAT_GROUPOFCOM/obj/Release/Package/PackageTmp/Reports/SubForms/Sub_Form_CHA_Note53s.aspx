...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Sub_Form_CHA_Note53s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.Sub_Form_CHA_Note53s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              বর্তমান কারমেয়াদে পরিশোধিত মোট সম্পরুক শুল্ক (নোট-৫৯)
            </p>
              <hr />
        </div>
