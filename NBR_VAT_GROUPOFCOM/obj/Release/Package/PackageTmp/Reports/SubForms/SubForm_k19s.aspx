...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_k19s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_k19s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
             রেয়াতযোগ্য নয় এরূপ পণ্য/সেবা (স্থানীয় ক্রয়) টাৰ্ণওভার প্রতিষ্ঠান হইতে (নোট ১৯)
            </p>
              <hr />
        </div>
