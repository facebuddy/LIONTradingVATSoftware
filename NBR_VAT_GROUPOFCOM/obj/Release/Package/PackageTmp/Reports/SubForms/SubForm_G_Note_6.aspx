<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="Reports_SubForms_SubForm_G_Note_6, App_Web_vvnwjv0y" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:16px;">
               সুনির্দিষ্ট কর ভিত্তিক পণ্য/সেবা  (নোট-৬) সাবফর্ম-গ 
            </p>
            <hr />
        </div>
                            ...
                            <div class="gridDiv table-responsive paddingsmall">  
                                <asp:GridView ID="gvSubForm_K" runat="server" AutoGenerateColumns="False" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="পণ্য/সেবা বাণিজ্যিক কোড" DataField="hs_code" />
                                        <asp:BoundField HeaderText="পণ্য/সেবা নাম" DataField="item_name" />
                                        <asp:BoundField HeaderText="পরিমাপের একক " DataField="price" />
                                        <asp:BoundField HeaderText="পরিমাপের " DataField="price" />
                                        <asp:BoundField HeaderText="প্রকৃতি বিক্রয়/ ক্রয় মূল্য" DataField="sd" DataFormatString="{0:#,#0.00}" ItemStyle-HorizontalAlign="Right"/>
