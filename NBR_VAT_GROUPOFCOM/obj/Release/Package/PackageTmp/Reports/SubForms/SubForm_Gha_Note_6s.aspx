<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_Gha_Note_6s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_Gha_Note_6s" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('</head><body style="margin: 50px;font-size:smaller;font-size:smaller;">');
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        ...
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              সুনির্দিষ্ট কর ভিত্তিক পণ্য/সেবা (নোট-৬) 
            </p>
            <hr />
        </div>
                            ...
                            <div class="gridDiv table-responsive paddingsmall">  
                                <asp:GridView ID="gvSubForm_ga" runat="server" AutoGenerateColumns="False"  OnRowDataBound="gvSubForm_ga_RowDataBound" ShowFooter="true" CssClass="sGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="মূল্য সংযোজন কর ()" DataField="purchase_vat" DataFormatString="{0:#,#0.00}" ItemStyle-HorizontalAlign="Right"/>
