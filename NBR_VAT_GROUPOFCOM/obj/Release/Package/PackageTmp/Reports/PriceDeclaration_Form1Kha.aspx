<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_PriceDeclaration_Form1Kha, App_Web_y1tsx4fu" %>
...
<table align="center" class="brd_tbl_input">
        <tr>
            <td class="page_title" colspan="2">
                মূল্য ঘোষণাপত্র - (মূসক-১খ) <uc1:ReportsNav ID="ReportsNav1" runat="server" /></td>
        </tr>
        <tr>
            <td class="style1">
