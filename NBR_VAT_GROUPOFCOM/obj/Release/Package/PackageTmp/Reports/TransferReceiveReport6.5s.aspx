<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="TransferReceiveReport6.5s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.TransferReceiveReport6__5s" %>
            ...
            <div class="panel-body" style="padding-top:0px; padding-bottom:2px;padding-right:2px">
               ...
               <div class="col-md-12" style="text-align:right">
                    ...
                    <asp:Button ID="btnShowReport" style="background-color:#5CB85C;margin-top:15px;" runat="server" class="btn-btn" OnClick="btnShowReport_OnClick" Text="Show Report" />
                      <asp:Button runat="server"  style="background-color:#5bc0de;margin-top:15px;" class="btn-btn" Text="Print" ID="btnPrint" OnClientClick="return PrintPanel()" />
               </div>
                </div>
                   </div>
            </div>
