<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_PurchaseDayItemChallanGrpRep, App_Web_pj2ymx2u" %>
...
<table align="center" class="brd_tbl_input">
         <tr>
            <td colspan="2" height="25" class="page_title">
               Purchase Statement <uc1:ReportsNav ID="ReportsNav1" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="style1">
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtChallanNo" runat="server" Width="111px" ></asp:TextBox>
               
            &nbsp;&nbsp;
                <asp:RadioButton ID="rdItem" runat="server" Checked="True" GroupName="GroupBy" 
                    Text="By Item" />
