...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SIMSVATReturnMushok19.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SIMSVATReturnMushok19" %>
                ...
                <div class="col-md-12">
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-5">
                            ...
                            <asp:Button ID="btnSave" runat="server" Style="background-color: #4CAF50;" CssClass="btn-btn" OnClick="btnSave_Click" Text="Save"  OnClientClick = "Confirm()" />   
        ...
        <div class="panel panel-primary panel-primary-custom">
            <div class="panel-heading panel-heading-custom">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:Button ID="btnOK" runat="server" Text="Update" Style="background-color: #4CAF50" class="btn-btn" OnClick="btnOkToReload" />
