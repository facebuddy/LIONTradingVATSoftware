<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Dispose_Inputs_Form26s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.Dispose_Inputs_Form26s" %>
    ...
    <div class="container-fluid">
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center; font-size: 21px; font-weight: bold; height: 30px; padding-top: 0px">অব্যবহৃত বা ব্যবহার অনুপযোগী উপকরণ নিষ্পত্তির আবেদনপত্র (মূসক-৪.৪)</div>
        ...
        <div runat="server" id="print">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">     <p style="text-align: right; padding: 5px;">
                     <b style="border: 1px solid gray;">মূসক-৪.৪</b>
                                                    </p></div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-6">
                        <center>
                     <asp:Label runat="server" class="control-label" style="font-size:16px; font-weight:bold">অব্যবহৃত বা ব্যবহার অনুপযোগী উপকরণ নিষ্পত্তির আবেদনপত্র</asp:Label><br />
                    </center>
                        <center>
                         <asp:Label runat="server" class="control-label">[ বিধি ২৪ক এর উপ-বিধি (১) দ্রষ্টব্য ]</asp:Label>
                     </center>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
           ...
           <br />
                        ...
                        <table class="table" border="1" style="background: none; border-collapse: collapse; width: 100%">
                                ...
                                <tr>
                                    <td>নিবন্ধিত/ তালিকাভুক্ত ব্যক্তির নাম :
                                        <asp:Label runat="server" ID="orgName" Style="font-weight: bold" /></td>                                        
                                    <td>বিআইন :
                                        <asp:Label runat="server" ID="orgBIN" CssClass="control-label" /></td>
                                </tr>
                                <tr>
                                 <td>ঠিকানা :
                                 <asp:Label runat="server" ID="orgAddress" CssClass="control-label" /></td>
                                 <td>পণ্যের এইচএস কোড :
                                   <asp:Label runat="server" ID="lblItem" CssClass="control-label" /></td>
                                </tr>
                        </table>
                    </div>
                   <div class="table-responsive">
                         <table class="" border="1" style="font-size:12px;">
                            <thead>
                                <tr>
                                    <th style="text-align: center">ক্রমিক সংখ্যা </th>
                                    <th style="text-align: center">উপকরণের নাম</th>
                                    <th style="text-align: center">ক্রয় চালানপত্রের ক্রমিক সংখ্যা</th>
                                      <th style="text-align: center">ক্রয় পুস্তকের ক্রমিক সংখ্যা</th>
                                    <th style="text-align: center">অব্যবহৃত বা ব্যবহার অনুপযোগী উপকরণের পরিমাণ</th>
                                    <th style="text-align: center">মূল্য </th>
                                    <th style="text-align: center">প্রদত্ত মূল্য সংযোজন কর </th>
            ...
            <div class="col-md-12">
                <asp:Label runat="server" style="margin-left:10px;">আমি ঘোষণা করিতেছি যে,এই আবেদনপত্রে প্রদত্ত সকল তথ্য সত্য ও সঠিক।</asp:Label>
                <br />
             <br />
             <br />
            </div>
