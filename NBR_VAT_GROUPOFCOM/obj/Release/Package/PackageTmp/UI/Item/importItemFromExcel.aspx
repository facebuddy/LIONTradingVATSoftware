<%@ page title="Import Items" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="UI_Item_importItemFromExcel, App_Web_jwpupl0k" enableeventvalidation="false" %>
        ...
        <div class="panel panel-primary">
            <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
                <div class="container-fluid">
                    <div class="gridDiv table-responsive paddingsmall text-center">
                      ...
                      <asp:GridView ID="gvExcelFile" runat="server" AutoGenerateColumns="false" CellPadding="4"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="ParentID" Value='<%# Eval("ParentID") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="CategoryID" Value='<%# Eval("CategoryID") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="ItemType" Value='<%# Eval("ItemType") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                  <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="ProductType" Value='<%# Eval("ProductType") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="MesurementIDD" Value='<%# Eval("MesurementIDD") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
