<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="UI_Item_ItemPriceDeclaration_1KA, App_Web_jwpupl0k" %>
    ...
    <table align="center" bgcolor="WhiteSmoke" border="0" cellpadding="0" 
        ...
        <tr>
            <td class="page_title" colspan="7" align="center">
                উপকরণ/উৎপাদন সম্পর্ক বা সহগ মূল্যভিত্তি ঘোষনাপত্র<uc1:ItemNav ID="ItemNav" runat="server" />&nbsp;(মূসক 
                - ১ক)</td>
        </tr>
        <tr>
...
&nbsp;<asp:Label ID="lblUnit" runat="server"></asp:Label>
        ...
        <tr>
            <td valign="top" align="right">
                <asp:Label ID="Label82" runat="server" Text="মন্তব্যঃ"></asp:Label>
            </td>
            <td colspan="6">
                <asp:TextBox ID="txtRemarks" runat="server" Width="700px" 
                    CssClass="text_box" MaxLength="150"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="6"></td>
                        ...
                        <tr>
                            ...
                            ShowDeleteButton="True" />
                                         ...
                                         <asp:TemplateField HeaderText="পরিমান">
                                             <ItemTemplate>
                                                 <asp:TextBox ID="txtItemQuantity" runat="server" onblur="showTotalQuantity(this)" Width="65px" Text="0.00"></asp:TextBox>
                                             </ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="অপচয়">
                                             <ItemTemplate>
                                                 <asp:TextBox ID="txtPrice" runat="server" CssClass="stdTextBox"  onblur="showPrice(this)"
