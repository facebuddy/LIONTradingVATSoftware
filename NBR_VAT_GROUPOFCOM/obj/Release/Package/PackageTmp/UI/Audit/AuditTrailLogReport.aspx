<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="AuditTrailLogReport, App_Web_qhrdyc5n" %>
            ...
            <div class="container-fluid">
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="text-align: center;  font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">Audit Trail Log Report</div>
                                ...
                                <table class="table" border="1" style="background: none;border-collapse:collapse;width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:8%;text-align: center;">Audit Part</th>
                                            <th style="width:7%;text-align: center;">Audit Date</th>
                                            <th style="width:10%;text-align: center;">Audit (from to Date)</th>
                                            <th style="width:5%;text-align: center;">Vat Month</th>
                                            <th style="width:30%;text-align: center;">Challan Numbers</th>
                                            <th style="width:10%;text-align: center;">Auditor Name</th>
                                            <th style="width:10%;text-align: center;">Auditor Designation</th>
                                            <th style="width:15%;text-align: center;">Auditor Comment</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <asp:Label runat="server" ID="lblLoadReport" />
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
