<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="IngredientsPurchaseInformations.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Audit.IngredientsPurchaseInformations" %>
    ...
    <div class="container-fluid">
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center; font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">উপকরণ সংক্রান্ত তথ্য (মূসক-৬.১ রেজিষ্টার মোতাবেক)</div>
        ...
        <div runat="server" id="print" style="font-family:Nikosh">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                        <center>
                     <asp:Label runat="server" class="control-label" style="font-size:16px; font-weight:bold">উপকরণ সংক্রান্ত তথ্য (মূসক-৬.১ রেজিষ্টার মোতাবেক)</asp:Label>
                    </center>
                    </div>
                    <div class="col-sm-4"></div>
                </div>
                ...
                <div class="form-group form-group-sm">
                    <div class="table-responsive">
                        <table class="table" border="1" style="background: none; border-collapse: collapse">
                            <thead>
                                <tr>
                                    <th rowspan="3" style="text-align: center">উপকরণের বিবরণ</th>
                                    <th rowspan="2" colspan="2" style="text-align: center">প্রারম্ভিক জের</th>
                                    <th rowspan="2" colspan="2" style="text-align: center">আমদানি</th>
                                    <th colspan="4" style="text-align: center">স্থানীয় ক্রয়</th>
                                    <th rowspan="2" colspan="2" style="text-align: center">মোট</th>
                                    <th rowspan="2" colspan="2" style="text-align: center">উৎপাদন ব্যবহার</th>
                                    <th rowspan="2" colspan="2" style="text-align: center">সমাপনী জের</th>
                                </tr>
                                <tr>
                                    <th colspan="2">নিবন্ধিত প্রতিষ্ঠান হতে (মূসক-৬.৩ এর মাধ্যমে)</th>
                                    <th colspan="2">অনিবন্ধিত প্রতিষ্ঠান হতে</th>
                                </tr>
                                <tr>
