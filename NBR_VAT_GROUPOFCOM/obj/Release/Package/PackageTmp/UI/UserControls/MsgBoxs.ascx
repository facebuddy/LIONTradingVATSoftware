...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MsgBoxs.ascx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.UserControls.MsgBoxs" %>
...
<asp:UpdatePanel ID="udpMsj" runat="server" UpdateMode="Conditional" RenderMode="Inline">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlMsg" runat="server" CssClass="mpMsg" Style="width: auto;display:none;" >
            ...
            <div class="mpClose">
                <asp:Button ID="btnOK1" runat="server" Text="OK" CausesValidation="false" Width="60px" />
                <asp:Button ID="btnPostOK1" runat="server" Text="OK" CausesValidation="false" OnClick="btnPostOK_Click" Visible="false" Width="60px" />
                <asp:Button ID="btnPostCancel1" runat="server" Text="Cancel" CausesValidation="false" OnClick="btnPostCancel_Click" Visible="false" Width="60px" />
            </div>
        </asp:Panel>
