<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="ProductsTransfer_6.5s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.ProductsTransfer_6__5s" %>
...
<%--    <link href="../../Styles/Main.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function btnPrint_click(Flag) {
            if (Flag == "Print") {
                var id = document.getElementById("ptPrint");
                if (id.style.display == 'none') {
                    document.getElementById("ptPrint").style.display = 'block';
                } else {
                    document.getElementById("ptPrint").style.display = 'none';
                }
            }
        }
                    ...
                    <div class="col-md-4">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-7 m">
                                ...
                                <asp:Button ID="btnAddParty" runat="server" style="float:left;margin-left:5px;height:27px" OnClick="btnAddParty_Click" Text="New" Width="60px" Visible="false" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-7 m">
                                 <asp:TextBox ID="txtChallanNo" runat="server" class="form-control" Enabled="false"></asp:TextBox>
                   ...
                   <%-- <div class="col-md-4">
                        <div class="form-group form-group-sm">
                            <label class="col-sm-5 control-label text-right"><span class="required" style="color:red"> * </span>ইস্যুর তারিখ :</label>
                            <div class="col-sm-7 m">
                               <asp:TextBox ID="txtChallanIssueDate" runat="server" CssClass="form-control"></asp:TextBox>
                              <ajaxToolkit:CalendarExtender ID="cc11" runat="server" Format="dd/MM/yyyy" TargetControlID="txtChallanIssueDate"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-group-sm">
                            <label class="col-sm-5 control-label text-right"><span class="required" style="color:red"> * </span>ইস্যুর সময় :</label>
                            <div class="col-sm-7 m">
                                <asp:TextBox ID="txtChallanIssueTime" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>--%>
                    <div class="col-md-4">
                     ...
                     <div class="row">
                      <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <label class="col-sm-5 control-label text-right">প্রদানকারী ইস্যুর তারিখ ও সময়:</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtChallanIssueDate" Style="width: 50%; float: left" CssClass="form-control" runat="server" DateFormat="dd/MM/yyyy"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="cc11" runat="server" Format="dd/MM/yyyy" TargetControlID="txtChallanIssueDate" />
                     ...
                     <div class="row" style="margin-top:10px;">
                        <div class="test-label hiddencol">
                            ...
                            <asp:DropDownList ID="drpType" runat="server" CssClass="category select2" style="width:100px;height:27px;text-align:left" AutoPostBack="True" OnSelectedIndexChanged="drpRole_SelectedIndexChanged" >
                        ...
                        <div class="test-label">
                            ...
                            <asp:DropDownList ID="drpCategory" runat="server" CssClass="category select2" style="width:100px;height:27px;text-align:left" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged" 
                        ...
                        <div class="test-label">
                            ...
                            CssClass="sub-category select2" style="height:27px;width:100px;text-align:left"></asp:DropDownList>
                        </div>
                       <%-- <div class="test-label">
                        ...
                        <div class="test-label">
                            <asp:Label ID="Label24" runat="server" Text="Item Name & SKU:" style="margin-left:0px;"/>
                            <asp:Label ID="lblSku" runat="server"></asp:Label>&nbsp<br />
                        ...
                        <div class="test-label">
                             ...
                             <asp:Label runat="server" ID="Label6" Text="Avl. Stock:"  style="color: #008000;font-weight:bold" /><asp:Label runat="server"  style="color: #008000;font-weight:bold" ID="lblAvailQuantity" />
                        ...
                        <div class="test-label">
                             ...
                             <asp:TextBox ID="lblUnit" runat="server" CssClass="unit" style="width:100px;"></asp:TextBox>
                        ...
                        <div class="test-label">
                                        ...
                                        <asp:Label ID="Label1" runat="server" Style="margin-left: 0px;" Text=<abbr title="Purchase Unit Price With VAT and SD">Unit Price(P):</abbr></asp:Label><br />
                                   ...
                                   <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4"
                                    ...
                                    <div class="test-label">
                                        <asp:Label ID="Label5" runat="server" Text="VAT:" Style="margin-left: 0px;" /><br />
                                        ...
                                        <asp:Label ID="lblfxdVT" runat="server" Text="" /> <asp:Label ID="lblPurchaseVAT" runat="server" Text="" /><asp:Label ID="Label7" runat="server"
                                            Text="%"></asp:Label>
                                    ...
                                    <div class="test-label">
                                        <asp:Label ID="Label8" runat="server" Text="SD:" Style="margin-left: 0px;" /><br />
                                        <asp:TextBox ID="txtPurchaseSD" CssClass="quantity" Style="background-color: #CAFDD2"
                                            runat="server" AutoPostBack="True" ReadOnly="true" Width="100px"></asp:TextBox>
                                        <asp:Label ID="lblPurchaseSD" runat="server" Text="" /><asp:Label ID="Label9" runat="server"
                                            Text="%"></asp:Label>
                        ...
                        <div class="test-label">
                            <asp:Label ID="Label37" runat="server" Text="Remarks:"/><br />
                            <asp:TextBox ID="txtRemark" CssClass="remark" TextMode="MultiLine" runat="server" AutoPostBack="True" ></asp:TextBox><br />
                        </div>
                      
                    </div>
                     <div class="row" style="margin-top:5px; margin-left:5px" runat="server" id="divProp">
                 <div class="test-label">
                   ...
                   <div class="row" style="text-align:right">
                       <div class="col-md-12">
                        <asp:Button ID="btnAdd" style="background-color:#B681B7;margin-top:15px; margin-left: 4px; margin-right:0px" runat="server" class="btn-btn" OnClick="btnAddItem_Click" Text="Add Item" />
                        ...
                        <asp:Button ID="btnShowReport" style="background-color:#5CB85C;margin-top:15px;" runat="server" class="btn-btn hiddencol" OnClick="btnShowReport_OnClick" Text="Show Report" />
                ...
                <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="False" CssClass="sGrid"
                    ...
                    <Columns>
                       ...
                       <%-- <asp:BoundField HeaderText="Property1" DataField="Property1" Visible="False" />
                        ...
                        <asp:BoundField HeaderText="Property1" DataField="Property11"  />
                        <asp:BoundField HeaderText="Property2" DataField="Property22"  />
                        <asp:BoundField HeaderText="Property3" DataField="Property33"  />
                        <asp:BoundField HeaderText="Property4" DataField="Property44" />
                        <asp:BoundField HeaderText="Property5" DataField="Property55" />
                        
                        <asp:BoundField HeaderText="Property1" DataField="Property1_Text" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        <asp:BoundField HeaderText="Property2" DataField="Property2_Text" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        <asp:BoundField HeaderText="Property3" DataField="Property3_Text" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        <asp:BoundField HeaderText="Property4" DataField="Property4_Text" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        <asp:BoundField HeaderText="Property5" DataField="Property5_Text" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
