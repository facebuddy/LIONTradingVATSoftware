<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="DebitNote_6.8s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.DebitNote_6__8s" %>
            ...
            <ContentTemplate>
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <%--<div class="panel-heading" style="text-align:center; font-size:21px; font-weight:bold; height:30px; padding-top:0px">ডেবিট নোট (মূসক-১২ক)</div>--%>
                        <div class="panel-heading" style="text-align: center;font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">ডেবিট নোট (মূসক- ৬.৮)</div>
                        ...
                        <div class="panel-body" style="padding-top: 0px; padding-bottom: 2px">
                            <div class="row" style="margin-top: 0px">
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="col-sm-4" style="padding: 0px">
                                        <div class="col-sm-4" style="padding: 0px">
                                            <asp:Label Style="margin-left: 100px" runat="server" Text="নাম:"></asp:Label>
                                        </div>
                                    ...
                                    <div class="col-sm-6" style="padding: 0px">
                                        <div class="col-sm-1" style="padding: 0px">
                                            <asp:Label ID="Label1" runat="server" Text="ঠিকানা:"></asp:Label>
                                        </div>
                            ...
                            <div class="row" style="margin-top: 20px">
                                <div class="col-sm-8" style="padding: 0px">
                                    <div class="col-sm-2" style="padding: 0px">
                                        <asp:Label ID="Label10" CssClass="present-address-lbl" Style="margin-left: 42px" runat="server" Text=""><span class="required">*</span>ডেবিট নোট নম্বর:</asp:Label>
                                        <asp:Label ID="debitNoteId" runat="server" Visible="false" />
                                    </div>
                                    <div class="col-sm-3" style="padding: 0px">
                                        <asp:TextBox ID="txtDebitNot" class="present-address-tb" runat="server" Style="width: 94%; height: 27px" Enabled="false"></asp:TextBox>
                                ...
                                <div class="col-sm-4" style="padding: 0px">
                                    <asp:Label ID="Label11" CssClass="present-address-lbl" runat="server" Style="margin-left: 9px; float: left; margin-top: 2px;"
                                        Text="গ্রহনকারী ইস্যুর তারিখ ও সময়:"></asp:Label>
                                    <asp:TextBox ID="txtRecipientDate" CssClass="present-address-tb" runat="server" Style="width: 122px; margin-left: 14px; float: left; height: 27px"
                                        DateFormat="dd/MM/yyyy" ReadOnly="true"></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender ID="cc11" runat="server" Format="dd/MM/yyyy" TargetControlID="txtRecipientDate" />
                                    <asp:DropDownList ID="drpRecipientHr" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpRecipientMin" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True">
                                    </asp:DropDownList>
                                </div>
                                <%--<div class="col-sm-2" style="padding:0px">
                          <div class="col-sm-5" style="padding:0px">
                             <asp:Label ID="Label11"  runat="server" Text="গ্রহনকারী ইস্যুর তারিখ:"></asp:Label>
                          </div>
                         <div class="col-sm-7" style="padding:0px">
                             <asp:Label ID="lblRecipientDate" style="margin-left: -10px;" runat="server"></asp:Label>
                         </div>
                        </div>
                        <div class="col-sm-2" style="padding:0px">
                        <div class="col-sm-5" style="padding:0px">
                            <asp:Label ID="Label12"  runat="server" Text="গ্রহনকারী ইস্যুর সময়:"></asp:Label>
                        </div>
                        <div class="col-sm-7" style="padding:0px">
                            <asp:Label ID="lblRecipientTime" style="margin-left: -15px;" runat="server"></asp:Label>
                        </div>
                        </div>--%>
                                <div class="col-sm-3 col-xs-3 col-lg-2">
                            ...
                            <div class="row" style="margin-top: 5px">
                                <div class="col-sm-8" style="padding: 0px">
                                    ...
                                    <div class="col-sm-10" style="padding: 0px">
                                        <asp:DropDownList ID="drpMainChallanNo" Style="width: 28%; height: 27px; text-align: left" class="present-address-tb" OnSelectedIndexChanged="drpMainChallanNo_selectedIndexChanged" runat="server" AutoPostBack="true"></asp:DropDownList>
                                        <asp:RadioButton runat="server" GroupName="debit_note" ID="rbLocalPurchase" Text="Local Purchase" Style="float: left" OnCheckedChanged="rbPurchase_OnCheckedChanged" AutoPostBack="true" />
                                        <asp:RadioButton runat="server" GroupName="debit_note" ID="rbImport" Text="Import" Style="float: left" OnCheckedChanged="rbPurchase_OnCheckedChanged" AutoPostBack="true" />
                                    </div>
                                </div>
                                <div class="col-sm-4" style="padding: 0px">
                                    <asp:Label ID="Label12" CssClass="present-address-lbl" runat="server" Style="margin-left: 8px; float: left; margin-top: 2px;"
                                        Text="প্রদানকারী ইস্যুর তারিখ ও সময়:"></asp:Label>
                                    <asp:TextBox ID="txtProviderDate" CssClass="present-address-tb" runat="server" Style="width: 122px; margin-left: 14px; float: left; height: 27px"
                                        DateFormat="dd/MM/yyyy" Enabled="false"></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txtProviderDate" />
                                    <asp:DropDownList ID="drpProviderHr" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True" Enabled="false">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpProviderMin" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True" Enabled="false">
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="row" style="margin-top: 20px;margin-left:5px">
                                <div class="test-label">
                                    ...
                                    <asp:DropDownList ID="drpType" runat="server" class="category" Style="width: 70px" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged"
                                        AutoPostBack="True">
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:Label ID="Label34" runat="server"><strong>বৃদ্ধির ধরন:</strong></asp:Label><br />
                                    <asp:DropDownList ID="drpDecreaseType" runat="server" Style="width:100px; text-align: left" class="category" AutoPostBack="True">
                                    </asp:DropDownList>
                                </div>
                                <div class="test-label">
                                    <asp:Label ID="Label22" runat="server"><strong>Category:</strong></asp:Label><br />
                                    <asp:DropDownList ID="drpCategory" runat="server"  class="category" Style="width:100px;text-align: left" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged"
                                        AutoPostBack="True">
                                    </asp:DropDownList>
                                </div>
                                <div class="test-label">
                                    <asp:Label ID="Label23" runat="server"><strong>Sub Cat:</strong> </asp:Label><br />
                                    <asp:DropDownList ID="drpSubCategory" runat="server" Style="width:100px;text-align: left" AutoPostBack="True" OnSelectedIndexChanged="drpSubCategory_SelectedIndexChanged"
                                        class="sub-category" Height="27px">
                                    </asp:DropDownList>
                                </div>
                                <div class="test-label" style="display: none;">
                                    <asp:Label ID="Label40" runat="server"><strong>Search Product:</strong></asp:Label>
                                ...
                                <div class="test-label">
                                    <asp:Label ID="Label24" runat="server" Style="margin-left: 0px;" />
                                    <strong>Item Name:</strong><br />
                                    <asp:DropDownList ID="drpItem" CssClass="item select2" Style="width: 220px; text-align: left" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpItem_SelectedIndexChanged" />
                                    <asp:Label runat="server" ID="itemProduct" Visible="false"></asp:Label>
                                ...
                                <div class="test-label">
                                    <asp:Label ID="Label25" runat="server"><strong>HS Code:</strong></asp:Label>
                                    <br />
                                    <asp:TextBox ID="lblHSCode" CssClass="hs-code" runat="server" Style="width: 100px" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="test-label">
                                    <asp:Label ID="Label26" runat="server" Style="margin-left: 0px;" /><strong>Quantity:</strong><br />
                                    <asp:TextBox ID="txtQuantity" runat="server" Style="width: 100px" class="quantity" AutoPostBack="True" OnTextChanged="txtQuantity_TextChanged"></asp:TextBox>
                                    <%--<asp:Label runat="server" style="margin-left:-40px" ID="Label13" Text="avl qnt:"/><asp:Label runat="server" ID="lblQuantity"/>--%>
                                    <asp:Label runat="server" Style="margin-left: -40px;color: #008000;font-weight:bold" ID="Label13" Text="Avl. Challan Qnt:" /><asp:Label style="color: #008000;font-weight:bold" runat="server" ID="lblQuantity" />
                                ...
                                <div class="test-label">
                                    <asp:Label ID="Label41" runat="server" Style="margin-left: 0px;" /><strong>Unit:</strong><br />
                                    <asp:TextBox ID="txtUnitName" CssClass="unit" runat="server" Style="width: 55px"></asp:TextBox>
                                    <asp:Label runat="server" ID="lblUnitId" Visible="false"></asp:Label>
                                </div>
                                <div class="test-label">
                                    <asp:Label ID="Label27" runat="server" Style="margin-left: 0px;" /><strong>Unit Price:</strong><br />
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:TextBox ID="txtTotalUnitPrice" ReadOnly="true" Style="width: 130px" CssClass="category" runat="server" placeholder="টাকায়"></asp:TextBox><br />
                                ...
                                <div class="test-label">
                                    <asp:Label ID="Label35" runat="server" Text="" Style="margin-left: 0px;" /><strong>বাদ কর্তন</strong><br />
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:TextBox ID="txtTotalPricewithVat" ReadOnly="true" OnTextChanged="PrevAmount_textChanged" Style="width: 130px" CssClass="category" runat="server" AutoPostBack="True"></asp:TextBox><br />
                            ...
                            <div class="row" style="margin-top: 10px">
                                ...
                                <div class="col-sm-6" style="padding: 0px; margin-top: -4px;">
                                    <asp:Button ID="btnAddRow" runat="server" class="btn-btn" Style="background-color: #B681B7; margin-left: 90px" Text="Add Item" OnClick="btnAddRow_Click" />
                                    <asp:Button ID="btnRefresh" runat="server" class="btn-btn" Style="background-color: #4CAF50; margin-left: 0px"
                                        Text="Refresh" OnClick="btnRefresh_Click" />
                                    <asp:Button ID="btnSave" runat="server" class="btn-btn" Style="background-color: #4CAF50; margin-left: 0px;"
                                        Text="Save Debit Note" OnClick="btnSave_Click" />
                                    <asp:Button ID="btnPrint" runat="server" class="btn-btn hiddencol" Style="background-color: #5CB85C; margin-left: 0px;"
                                        Text="Show Report" OnClick="btnPrint_Click" />
                                    <asp:Button ID="btnOA" runat="server" class="btn-btn hiddencol" Style="background-color: #4CAF50; margin-left: 0px;"
                                        Text="Others Adjusment" OnClick="btnOA_Click" />
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            ShowSelectButton="True" />--%>
                                        ...
                                        <asp:BoundField HeaderText="Quantity" DataField="DebQuantity" DataFormatString="{0:n2}"/>
                ...
                <div class="row" style="text-align:right" runat="server" visible="false" id ="divSearch">
                 ...
                 <div class="row">
                        ...
                        <div class="col-md-12">
                                     ...
                                     <div style="font-size: 16px">
                                         <img src="../../Images/bdlogo.png" style="height: 50px; margin-left: 80px;"></img>
                                                    <p style="text-align: right; padding: 5px;">
                                                        <b style="border: 1px solid gray; margin-right: 17px;">মূসক-৬.৮</b>
                                                    </p>
                                                    ...
                                                    <p style="text-align: center; font-size: 12px; margin: 2px;"><strong>ডেবিট নোট</strong></p>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="2" style="text-align: center; font-weight: normal; text-align: center; border: 1px solid #000">ক্রেডিট নোট ইস্যুর কারণ
                                             ...
                                             <th  colspan="4" style="text-align: center; font-weight: normal; text-align: center; border: 1px solid #000">বৃদ্ধিকারী সমন্বয়ের সহিত সংশিষ্ট
                                            </th>
                                             </tr>
                                            <tr>
                          ...
                          <div style="text-align:right;margin-right:100px;">
                                   <%-- <p>ফেরতের কারণ: <asp:TextBox ID="txtreason" runat="server" style="width:1200px"></asp:TextBox></p>--%>                                   
                                     ...
                                     <p style="margin-top:15px;">সাক্ষর:   <asp:Label ID="Label4" runat="server"></asp:Label></p>
                                     <p style="margin-top:15px;">সিল:   <asp:Label ID="Label5" runat="server"></asp:Label></p>                             
                                ...
                                <div class="col-md-12" style="margin-top: 5px">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <asp:Label runat="server" ID="Label28" Style="float: right" Text="Print DateTime: "></asp:Label>&nbsp&nbsp
                                    </div>
                                </div>
                    ...
                    <div runat="server" class="container-fluid" id="cnPrint" visible="false" style="width: 100%;">
        ...
        <td> <img src="../../Images/bdlogo.png" style="height:50px;margin-left:80px;margin-top:-100px" ></img></td>
         ...
         <div class="row" style="margin-right:220px">
              <p style="text-align: center">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</p>
                            ...
                            <p style="text-align: right"><b style="border: 1px solid #000">মূসক-১২ক</b></p>
                            <p style="text-align: center"><b>ডেবিট নোট</b></p>
                        ...
                        <div class="row" style="width: 100%; height: 0px;">
                            <div class="col-sm-6" style="width: 50%; height: 150px; float: left">
                                ...
                                <p>
                                    নামঃ&nbsp
                                    <asp:Label runat="server" ID="lblProviderName" Style="font-weight: bold" />
                                </p>
                                <p>
                                    বিআইএনঃ&nbsp
                                    <asp:Label runat="server" ID="lblProviderBIN" Style="font-weight: bold" />
                                </p>
                                <p>
                                    মূল চালান নম্বরঃ&nbsp
                             
                                    <asp:Label runat="server" ID="lblProviderChallan" Style="font-weight: bold" />
                                </p>
                                <p>
                                    মূল চালান ইস্যুর তারিখঃ&nbsp
                                    <asp:Label runat="server" ID="lblProviderDate" Style="font-weight: bold" />
                                </p>
                            </div>
                            <div class="col-sm-6" style="border-left: 1px solid #000; width: 49%; float: left">
                                ...
                                <p>
                                    নামঃ&nbsp
                                    <asp:Label runat="server" ID="lblReceiverName" Style="font-weight: bold" />
                                </p>
                                <p>
                                    বিআইএনঃ&nbsp
                                    <asp:Label runat="server" ID="lblReceiverBIN" Style="font-weight: bold" />
                                </p>
                                <p>
                                    ডেবিট নোট নম্বরঃ&nbsp
                                    <asp:Label runat="server" ID="lblReceiverNoteNumber" Style="font-weight: bold" />
                                </p>
                                <p>
                                    ইস্যুর তারিখঃ&nbsp
                                    <asp:Label runat="server" ID="lblReceiverDate" Style="font-weight: bold" />
                                </p>
                                <p>
                                    ইস্যুর সময়ঃ&nbsp
                                    <asp:Label runat="server" ID="lblReceiverTime" Style="font-weight: bold" />
                                </p>
                            </div>
                        </div>
                        <div class="row" style="width: 100%; margin-top: 10px">
                            <table class="table table-bordered" style="background: none; border-collapse: collapse; width: 100%">
                                <tr>
                                    ...
                                    <td style="border: 1px solid gray">ফেরতপ্রদত্ত সরবরাহের বিবরণ</td>
                        ...
                        <div class="row" style="width: 100%; height: 0px; margin-top: 5px">
                            <p>ফেরতের কারণ</p>
                            <p>
                                <asp:TextBox runat="server" ID="ReturnComment" Style="width: 100%" TextMode="MultiLine" />
                            </p>
                        </div>
                        <div class="row" style="width: 100%; margin-top: 10%">
                            ...
                            <p><sup>২</sup>ফেরত প্রদানের জন্য কোনো ধরনের কর্তন থাকিলে উহার পরিমাণ।</p>
