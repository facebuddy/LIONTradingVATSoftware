<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="UI_Admin_RebateAdjustmentPurchase, App_Web_z1w3wddp" %>
        ...
        <ContentTemplate>
            <div class="container-fluid">
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="text-align: center; font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">রেয়াত  সমন্বয় (ক্রয়) </div>
                                    ...
                                    <div class="col-sm-3" style="padding: 0px">
                                     ...
                                     <div class="col-sm-3">
                                      <div class="form-group form-group-sm">
                                       <asp:Label class="col-sm-6 control-label" ID="Label21" runat="server" style="text-align:right;"><span class="required"> * </span>Adjustment Tax Period:</asp:Label>
                                        <div class="col-sm-6">
                                      ...
                                      <div class="col-sm-3">
                                      <div class="form-group form-group-sm">
                                       <asp:Label class="col-sm-4 control-label" ID="Label7" runat="server" style="text-align:right;">Party Name:</asp:Label>
                                        <div class="col-sm-8">
                                          <asp:DropDownList ID="drpParty"  CssClass="form-control select2" runat="server" />
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="" runat="server" id="gridviewPurchase">
                                <asp:GridView ID="gvLocalPurchase" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkChallan" runat="server" onclick="addVat(this)" OnCheckedChanged="chkChallan_CheckedChanged" AutoPostBack="true" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <asp:Button ID="btnUpdate" runat="server" visible="false" Text="Save" Style="background-color: #4CAF50;float: right" CssClass="btn-btn"  ValidationGroup="addCategory" OnClick="btnUpdate_Click" />
                        </div>
                    </div>
                    <div class="panel panel-primary">
                                ...
                                <asp:GridView ID="gvImport" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvImport_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkimport" runat="server" onclick="addVat(this)" OnCheckedChanged="chkimport_CheckedChanged" AutoPostBack="true"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="Challan No" DataField="ChallanNo" />
                                        <asp:BoundField HeaderText="Challan Date" DataField="ChallanDate" />
                                  ...
                                  <asp:Button ID="btnImportUpdate" runat="server" Text="Save"  Style="background-color: #4CAF50;float: right" CssClass="btn-btn" visible="false"
            ...
            <div id="pnLocalPurchase" cssclass="popupBlock" runat="server" style="background: #C0C0C0; box-shadow: 10px 10px 5px #888888; width: 80%; margin-left: 9%;">
                ...
                <div class="row" style="margin-top: -4px; margin-right: 1%; margin-left: 1%;">
                    <asp:GridView ID="gvPurchase2" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="CheckBox2" runat="server" onclick="addVat(this)" Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HiddenField runat="server" ID="HiddenField1" Value='<%# Eval("RowId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <HeaderStyle Height="25px" />
                  ...
                  <div class="row" style="text-align: center" runat="server" visible="false">
                      <div class="col-md-6">
                    ...
                    <asp:GridView ID="gvImport2" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="CheckBox3" runat="server" onclick="addVat(this)" Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="Challan No" DataField="challan_no" />
                            <asp:BoundField HeaderText="Challan Date" DataField="challan_date" />
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HiddenField runat="server" ID="HiddenField2" Value='<%# Eval("RowId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <HeaderStyle Height="25px" />
