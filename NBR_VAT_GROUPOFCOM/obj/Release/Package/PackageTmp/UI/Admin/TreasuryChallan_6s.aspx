...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="TreasuryChallan_6s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.TreasuryChallan_6s" %>
<%--<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="TreasuryChallan_6, App_Web_znns2ib5" %>--%>
                     ...
                     <div class="row">
                          ...
                          <div class="row">                            
                           ...
                           <div class="row">
                            <div class="col-sm-4">
                             ...
                             <div class="test-btn">
                                <asp:Button ID="btnAddItem" runat="server" CssClass="btn-btn" OnClick="btnAddItem_Click" style="background-color:#4CAF50;float:right;margin-right: 1px;"
                                    Text="Add Item" />
                             </div>
                             <div class="test-btn">
                        ...
                        <div class="col-sm-12" style="padding:0px">
                         <div class="col-sm-12">
                            ...
                            <div class="col-sm-9">
                                <asp:RadioButton Visible="false"  ID="radio_challan_list" Text="Sales Challan List"  GroupName="vat_type" runat="server" OnCheckedChanged="radio_challan_list_CheckedChanged" style="display:none" AutoPostBack="true" />
                                <asp:RadioButton ID="radio_non_challan" Checked="True" Text="Sale" GroupName="vat_type" runat="server" OnCheckedChanged="radio_non_challan_CheckedChanged" AutoPostBack="true" onclick="clearChkBox(this)" />
                            ...
                            <div class="col-sm-12 col-m" runat="server" id="gvDiv" style="margin-top:5px;">
                ...
                TargetControlID="hiddenSale" BackgroundCssClass="mpBack">
                   ...
                   <div class="row">
                     <div class="col-sm-12">
                        ...
                        OnRowDeleting="dgvTreasuryDeposit_RowDeleting" HeaderStyle-BackColor="Green" 
                        ...
                        <Columns>
                            ...
                            <HeaderStyle Height="25px" BackColor="#00CC00" Font-Bold="True" 
                              ForeColor="White" />
