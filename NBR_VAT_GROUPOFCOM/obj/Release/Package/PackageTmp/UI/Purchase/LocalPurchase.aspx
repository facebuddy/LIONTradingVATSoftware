...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="LocalPurchase.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Purchase.LocalPurchase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function chkCheckedEvent() {
            ...
            //result = parseFloat(cashAmt) + parseFloat(payOrderAmt) + parseFloat(checkAmt) + parseFloat(bKashAmt) + parseFloat(ttAmt) + parseFloat(eftAmt) + parseFloat(debitCreditAmt) + parseFloat(rocketAmt)
            //alert(result);
            //$("#txtCreditAmount").val(result);
        }

        <%--$(function () {
            $("#<%= drpParty.ClientID %>").live('change', function () {
                //alert('fire');
                ...
                if (textBoxValue == '') {
                    ...
                    setTimeout('__doPostBack(\'<%= drpParty.ClientID %>\',\'\')', 0);
                }
            });

            $("#<%= drpParty.ClientID %>").live('keypress', function () {
        ...
        function calculation(selectedgrid) {
            ...
            // var discount = parseFloat(rows.cells[5].getElementsByTagName('input')[0].value);
            ...
            <ContentTemplate>
                <div class="panel panel-group">
                                 ...
                                 <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                           <asp:TextBox ID="txtrefChallanDate" CssClass="form-control" Style="width: 50%; float: left" runat="server" ReadOnly="false" DateFormat="dd/MM/yyyy"></asp:TextBox>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                      <%--  <label class="col-sm-5 control-label text-right">Transaction Type :</label>--%>
                                        <div class="col-sm-7">
                                           <%-- <asp:DropDownList ID="drpTransactionType" CssClass="form-control" runat="server">
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                       <%-- <label class="col-sm-5 control-label text-right">Purchase Type :</label>--%>
                                        <div class="col-sm-7">
                                             <%--<asp:DropDownList ID="drpPurchaseType" CssClass="form-control" runat="server">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                      <%--  <label class="col-sm-5 control-label text-right">Agreement No :</label>--%>
                                        ...
                                        <div class="col-sm-7">
                                           <%-- <asp:TextBox runat="server" ID="txtAggrementNo" CssClass="form-control"/>--%>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                      <%--  <label class="col-sm-5 control-label text-right">Bank Name :</label>--%>
                                        <div class="col-sm-7">
                                            <%--<asp:DropDownList ID="drpBank" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpBank_SelectedIndexChanged">
                                            </asp:DropDownList>--%>
                                             <asp:HiddenField ID="hdPriceID" runat="server" />
                                            <asp:HiddenField ID="hdUnitSDAmt" runat="server" />
                                            <asp:HiddenField ID="hdUnitVATAmt" runat="server" />
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <%--<label class="col-sm-5 control-label text-right">Bank Branch :</label>--%>
                                        <div class="col-sm-7">
                        ...
                        <div class="panel-body" style="padding-right: 0px; padding-bottom: 0px">
                            <div class="container-fluid">
                                <div class="row" >
                                    ...
                                    <div class="col-md-4">
                                        <asp:RadioButton runat="server" ID="chkManualInput" Text="Manual Input" GroupName="manual" Visible="false" OnCheckedChanged="chkManualInput_OnCheckedChanged" AutoPostBack="true" Checked="true" />
                                        <asp:RadioButton runat="server" ID="chkExcelImport" Text="Import from Excel" GroupName="manual" Visible="false" OnCheckedChanged="chkExcelImport_OnCheckedChanged" AutoPostBack="true"/>
                                        <asp:RadioButton runat="server" ID="chkVoucherNo" Text="Add By Voucher No" GroupName="manual" Visible="false" OnCheckedChanged="chkVoucherNo_CheckedChanged" AutoPostBack="true"/>
                                    </div>
                                    <div class="col-md-4"></div>
                                  </div>
                                <div class="row" runat="server" id="part_a">
                                    <div class="test-label">
                                        ...
                                        <asp:DropDownList ID="drpCategory" Style="text-align: left" runat="server" CssClass="category" Width="90px"
                                    ...
                                    <div class="test-label">
                                        ...
                                        <asp:DropDownList ID="drpSubCategory" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpSubCategory_SelectedIndexChanged" Width="90px"
                                    ...
                                    <div class="test-label">
                                        ...
                                        <asp:TextBox ID="lblHSCode" runat="server" Style="width:80px; height: 27px" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="test-label">
                                    ...
                                    <div class="test-label">
                                        ...
                                        <asp:TextBox ID="txtPurchaseUnitPrice" CssClass="category" Style="background-color: #CAFDD2"
                                            runat="server" AutoPostBack="True" OnTextChanged="txtUnitPrice_TextChanged" Width="100px"/>
                                    ...
                                    <div class="test-label">
                                       ...
                                       <%--<asp:TextBox ID="txtTotalPrice" CssClass="category" Style="background-color: #CAFDD2" runat="server" ReadOnly="true"/>--%>
                                   ...
                                   <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4"
                                    ...
                                    <div class="test-label">
                                        ...
                                        <asp:Label ID="lblfxdVT" runat="server" Text="" /> <asp:Label ID="lblPurchaseVAT" runat="server" Text="" /><asp:Label ID="Label25" runat="server"
                                            Text="%"></asp:Label>
                                 ...
                                 <%--    //start 02/01/2020 added by the instruction of ruhul vai--%>
                                     <div class="test-label">
                                    ...
                                    <div class="test-label">
                                        <asp:Label ID="lblAIT" runat="server" Text="AIT:" Style="margin-left: 0px;" Visible="false" /><br />
                                        <asp:TextBox ID="txtAIT" CssClass="quantity" Style="background-color: #D4FCFF"
                                            runat="server" AutoPostBack="True" Visible="false" Width="100px"></asp:TextBox>
                                        <asp:Label ID="lbelAIT" runat="server" Text="" Visible="false"/><asp:Label ID="lblAITPct" runat="server"
                                            Text="%" Visible="false"></asp:Label>
                                      <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender13"
                                                        runat="server" Enabled="True" TargetControlID="txtAIT"
                                                        ValidChars=".0123456789">
                                                    </ajaxToolkit:FilteredTextBoxExtender>
                                         </div>
                                       <div class="test-label" runat="server" id="partVDS">
                                        <asp:Label ID="lblvdstx" Style="float: left; margin-top: 3px"
                                            runat="server" Text="VDS Amount:"  /><br />
                                      ...
                                      <div class="test-label">
                                        ...
                                        <asp:TextBox ID="remarks2" runat="server" CssClass="present-address-tb" Style="width: 100%;
                                   ...
                                   <div style="text-align: right; float: right; font-size: 14px; margin-right: 2%; border: 1px solid #ff00ff;margin-top:17px">
                                       ...
                                       <%-- <asp:Label ID="Label3" runat="server" Text="AIT Amount:" Font-Bold="True" />--%>
                                       <%-- <asp:Label ID="lblTotalAIT" runat="server" Style="font-size: 12px; margin-right: 0px" Text="0.00" Font-Bold="false" /><br />--%>
                                    ...
                                    <%--    //end 02/01/2020 added by the instruction of ruhul vai--%>
                                    <%-- <div class="test-label">
                                       <asp:CheckBox ID="chkIsFixed" runat="server" Text="Fixed VAT" AutoPostBack="true" Enabled="false" />
                                    </div>--%>
                               
                                </div>
                                 <div class="row"><asp:Label ID="lblPriceDiff" runat="server" Text="" /></div>
                                <div class="row" style="margin-top: 1%" runat="server" id="part_c">
                                       
                                 <div class="test-check" style="margin-top:-15px">
                                        <asp:CheckBox ID="chkTaxDeducted" runat="server" OnCheckedChanged="chkTaxDeducted_CheckedChanged" Text="VDS" AutoPostBack="true" />
                                        ...
                                        <asp:CheckBox ID="chkReduce" runat="server" Text="Reduce" AutoPostBack="true" Enabled="false" />
                                        <asp:CheckBox ID="chkReusable" runat="server" AutoPostBack="true" ForeColor="green"  OnCheckedChanged="ChckedChanged" Text="Reusable?"/>
                                ...
                                <div class="row"  runat="server" id="part_d">
                                    ...
                                    <div class="test-btn">
                                         ...
                                         <asp:Panel ID="ModalPanel" runat="server" Width="800" CssClass="modal_custom" BorderWidth="2px" BorderColor="Blue">
                                            <table style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="auto-style1"> 
                                                        <asp:TextBox ID="txtCashAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                    ...
                                                    <td class="auto-style1">
                                                     ...
                                                     <td class="auto-style1"> <asp:TextBox ID="txtCreditAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox></td>
                                                     <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True" TargetControlID="txtCreditAmount" FilterType="Numbers" FilterMode="ValidChars">
                                                        </cc1:FilteredTextBoxExtender>--%>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtChequeAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtRocketAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtbKashAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtTPTAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtEFTAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtDebitCartAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                       <asp:TextBox ID="txtPayOrderAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;" ></asp:TextBox>
                                                    ...
                                                    <td> 
                                                        <asp:TextBox ID="txtOthersAmount" runat="server" CssClass="form-control onlyFloat payment" style="width:130px;" ></asp:TextBox>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td style="text-align:right;">
                                                         ...
                                                         <asp:HiddenField runat="server" ID="txtExtraPaid"/>
                                                          <asp:Button ID="OKButton" runat="server" CssClass="btn-btn"  style="background-color: #0D7B78;" Text="OK" Width="50px" OnClick="OKButton_Click" OnClientClick="confirmPayment()"/>
                                        ...
                                        <div class="test-btn">
                                        <asp:Button ID="btnAdd" runat="server" class="btn-btn" style="background-color:#4CAF50;" OnClick="btnAddItem_Click" Text="Add Item" />&nbsp
                                    </div>
                                     <div class="test-btn">
                                      <asp:Button ID="ClientButton" runat="server" style="background-color:#4CAF50;" Text="Add Payment" class="btn-btn" />
                                    ...
                                    <div class="test-btn">
                                     ...
                                     <div class="test-btn">                                     
                                      <asp:HyperLink class="btn-btn" style="background-color:#4CAF50;text-align:center" Height="25px" Width="100px" NavigateUrl="~/UI/Purchase/ImportExcelLocalPurchase.aspx" runat="server">Import Excel</asp:HyperLink>
                                     </div>
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <%--<asp:Button ID="btnExcelSave" runat="server" OnClick="btnExcelSave_Click" Text="Save" CssClass="btn-btn"  style="background-color:#0D7B78"/>--%>
                    </div>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-4">
                                             ...
                                             <div class="col-sm-4">
                                                ...
                                                <%-- <asp:Button ID="btnAddPaymentmqmm" runat="server" Style="width: 100px" Text="Add Payment" class="test-btn-primary" />
                                                  <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="btnAddPaymentmqmm"
                ...
                <div class="container-fluid">
                  <div class="gridDiv table-responsive paddingsmall" runat="server">
                        ...
                        <div style="text-align: right" class="hiddencol">
                            ...
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" Text="Total Purchase Amount :"></asp:Label> <asp:TextBox ID="txtTotalVAT" Width="130px" runat="server" ReadOnly="True"></asp:TextBox>
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="Small" Text="Total Purchase Amount :"></asp:Label> <asp:TextBox ID="txtTotalAIT" Width="130px" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                        </div>
