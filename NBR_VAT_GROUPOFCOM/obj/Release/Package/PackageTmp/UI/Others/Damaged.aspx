<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="Damaged, App_Web_0aej32q1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align:center; font-size:21px; font-weight:bold; height:30px; padding-top:0px">ক্ষতিগ্রস্ত বা ধ্বংসপ্রাপ্ত বা সরবরাহের অযোগ্য পণ্য নিষ্পত্তির আবেদনপত্র (মূসক-২৭)</div>
          <div class="panel-body">
              ...
              <div class="col-md-3">
                  <div class="form-group form-group-sm">
                      ...
                      <div class="col-sm-7">
                          <asp:TextBox runat="server" ID="txtChallanNo" CssClass="form-control" />
                      </div>
                  </div>
              </div>
              <div class="col-md-3">
        ...
        <div class="panel panel-primary">
          <div class="panel-body">
           <div class="row">
              <div class="col-md-4">
                  <div class="form-group form-group-sm">
                      <label class="col-sm-5 control-label">Purchase Challan No :</label>
                      <div class="col-sm-7">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                  <div class="form-group form-group-sm">
                      <label class="col-sm-5 control-label">Damaged Quantity :</label>
                      <div class="col-sm-7">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group form-group-sm">
                      <label class="col-sm-5 control-label">Present Unit Price :</label>
                      <div class="col-sm-7">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group form-group-sm">
                      <label class="col-sm-5 control-label">Damaged Reason :</label>
                      <div class="col-sm-7">
                         <asp:DropDownList ID="drpDisposalReason" runat="server" CssClass="form-control">
                             <%--<asp:ListItem Value="1">Damaged</asp:ListItem>
                             <asp:ListItem Value="2">Demolished</asp:ListItem>
                             <asp:ListItem Value="3">Unable to supply</asp:ListItem>--%>
                         </asp:DropDownList>
                     </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-4">
                      <div class="form-group form-group-sm">
                           <asp:HiddenField ID="hfUnitId" runat="server" />
                            <asp:Button ID="btnSaveItem" runat="server" CssClass="btn btn-primary" Text="Add Item" onclick="btnSaveItem_Click" />
                           <%-- <asp:Button ID="btnRefreshItem" runat="server" CssClass="btn btn-primary" Text="Refresh" onclick="btnRefreshItem_Click" />--%>
                            <asp:Button ID="btnSaveChallan" runat="server" CssClass="btn btn-primary" Text="Dispose" onclick="btnSaveChallan_Click" />
                           <asp:Button ID="btnRefreshChallan" runat="server" CssClass="btn btn-primary" Text="Refresh" onclick="btnRefreshChallan_Click" />
                      </div>
                  </div>
              </div>
          </div>
