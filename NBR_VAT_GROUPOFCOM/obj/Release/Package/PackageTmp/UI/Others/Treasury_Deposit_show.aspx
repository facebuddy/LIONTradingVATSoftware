<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="UI_Others_Treasury_Deposit_show, App_Web_0aej32q1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Button ID="basic" runat="server" CssClass="button" Text="Insert New TR Challan No" OnClick="basic_Click"/>
    <asp:Button ID="Advanced" runat="server" CssClass="button btn-danger" Text="Edit Existing TR Challan" OnClick="Advanced_Click"/>
                ...
                <asp:TemplateField HeaderText="">        
                    ...
                    <ItemTemplate>
                        <asp:Button ID="addTRchallanBtn" runat="server"  CommandName="AddTRchallan" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"                               
                          CssClass="button"    Text="Update TR Challan" />
                    </ItemTemplate>         
                </asp:TemplateField>   
