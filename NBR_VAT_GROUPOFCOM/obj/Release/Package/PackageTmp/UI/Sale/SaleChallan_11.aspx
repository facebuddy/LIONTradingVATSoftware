<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="SaleChallan_11, App_Web_ebyme1bz" maintainscrollpositiononpostback="false" %>
    ...
    <div class="container-fluid" style="padding-right: 0%; padding-left: 0%">
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="text-align: center; font-family:Tahoma; font-size:18px; font-weight: bold;">
                            ...
                            Sale Challan / বিক্রয় চালানপত্র (মূসক-৬.৩)
                        </div>
                        <div class="panel-body">
                            <div class="row hiddencol" style="background-color: #FFD9C3; margin-top: -1.15%;">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtChallanNo" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-2 hiddencol" style="padding-left: 0px; padding-right: 0px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">                                       
                                        ...
                                        <div class="col-sm-5">
                                           <asp:TextBox ID="txtAggrementNo" CssClass="form-control" runat="server" Style="float: left"></asp:TextBox>
                                                <asp:DropDownList id="drpAgreement" runat="server" CssClass="form-control select2" name="" Visible="false" Style="height:30px; float: left" AutoPostBack="true" OnSelectedIndexChanged="drpAgreement_SelectedIndexChanged" >                                                
                                                </asp:DropDownList>
                                        </div>
                                        <div class="col-sm-2" style="padding-left: 0px; padding-right: 0px;">
                                           <asp:CheckBox ID="chkInstallment" runat="server" Text="EMI" AutoPostBack="true" OnCheckedChanged="chkInstallment_CheckedChanged" />
                                        </div>
                                    </div>
                                            ...
                                            <asp:Label runat="server" ID="installmentStatus" CssClass="hiddencol"></asp:Label>
                                              <asp:Label runat="server" ID="scheduleId" CssClass="hiddencol"></asp:Label>
                            ...
                            <div class="row" runat="server" id="divexport">
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="lblExpDt" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="Export Date :" ></asp:Label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtExportDate" CssClass="form-control" runat="server"
                                                DateFormat="dd/MM/yyyy" OnTextChanged="txtChallanDate_TextChanged"></asp:TextBox>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="lblExpBillNo" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="Export Bill No :"></asp:Label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtExpBillNo" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                  <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="Label10" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="Port Code :"></asp:Label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="drpPortCode" CssClass="form-control" runat="server" ></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="Label50" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="No of Item :"></asp:Label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtnoItem" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="Label51" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="Total Pac :"></asp:Label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtTotalPack" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="Label52" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text="" ><span class="required">*</span>CPC :</asp:Label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="drpCPC" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="lblBank" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text=""><span class="required">* </span>Bank :</asp:Label>
                                        <div class="col-sm-7">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        <asp:Label ID="lblBranch" CssClass="col-sm-5 control-label text-right" Style="font-weight: bold" runat="server" Text=""><span class="required">* </span>Branch :</asp:Label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="drpBranch" CssClass="form-control select2" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body" style="padding-right: 0px; padding-bottom: 0px">
                            <div class="container-fluid">
                                <div class="hiddencol" runat="server" >
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <asp:RadioButton runat="server" ID="chkManualInput" Text="Manual Input" GroupName="manual" OnCheckedChanged="chkManualInput_CheckedChanged" AutoPostBack="true" Checked="true" />
                                        <asp:RadioButton runat="server" ID="chkExcelImport" Text="Import from Excel" GroupName="manual" OnCheckedChanged="chkExcelImport_CheckedChanged" AutoPostBack="true" />
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                                <div class="row" runat="server" id="div_a">
                                    ...
                                    <%--itemSerialInputs--%>                                
                                        <div class="test-label" id="itemSerialSection">
                                            <asp:Label ID="Label31" runat="server" Style="margin-left: 0px;" Text="Serial Codes :"></asp:Label><br />
                                      ...
                                      <div class="test-label">
                                            <asp:Label ID="Label38" runat="server" Style="margin-left: 0px;" Text="Remarks:"></asp:Label><br />
                                     ...
                                     <div class="test-label"  runat="server" id="divaddprop" visible="false">
                                            <asp:Label ID="Label55" runat="server" Style="margin-left: 0px;" Text="Additional Property:"></asp:Label><br />
                                            <asp:TextBox ID="txtaddProp" TextMode="MultiLine" runat="server" Style="float: left; width: 250px; text-align: left"
                                                CssClass="present-address-tb"></asp:TextBox>
                                          
                                        </div> 
                                     <div class="test-label" runat="server" id="divHlthChrg" visible="false">
                                        <asp:Label ID="Label30" runat="server" Style="margin-left: 0px;" Text="Health Surcharge"></asp:Label><br />
                                ...
                                <div class="row" style="margin-top: 1%" runat="server" id="div_b">
                                    ...
                                    <div class="test-check">
                                            <asp:Label ID="Label47" runat="server" Visible="false"></asp:Label><br />
                                            <asp:CheckBox ID="giftCheckBox" runat="server" Text="Add Gift" AutoPostBack="True"
                                                OnCheckedChanged="giftCheckBox_CheckedChanged" />
                                        </div>
                                 <%--sabbir 17/2/21 add gift check box--%>
                                   ...
                                   <div class="test-check" runat="server" id="partVDS">
                                    ...
                                    <%-- sabbir gift item loading grid 22/2/21--%>
                    
                <asp:Panel id="giftPanel" runat="server" visible="false">
                    <hr style="border: 1px solid;" />
                               <div class="test-label">
                                    ...
                                    <%--<asp:Label runat="server" ID="Label39" Visible="false" /><br />
                                        <asp:Label ID="Label45" Style="margin-left: 0px" runat="server" Text="SKU :"></asp:Label>
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:Label ID="Label45" Style="margin-left: -60px; color: #008000; font-weight: bold" runat="server" Text="Avl. Stock:"></asp:Label>
                                    <asp:Label ID="lblGiftAvailStock" Style="color: #008000; font-weight: bold" runat="server" CssClass="hiddencol"></asp:Label>
                                    <asp:Label ID="lblgiftavlstock" Style="color: #008000; font-weight: bold" runat="server"></asp:Label>
                                ...
                                <div class="test-label" style="padding-left:10px;">
                                    <br /> 
                                        <asp:Button ID="btnAddGift" runat="server" class="btn-btn" Style="background-color: #B681B7" OnClick="btnAddGiftItem_Click" Text="Add Gift" />
                                    </div>
                ...
                <%-- end sabbir gift item loading grid 22/2/21--%>  
                                ...
                                <div class="row" style="margin-top: 1%" runat="server" id="div_c">
                                        ...
                                        <td></td>--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">
                                                        ...
                                                        <asp:Button ID="OKButton" runat="server" CssClass="btn-btn"  style="background-color: #4CAF50;" Text="OK" Width="50px" OnClick="OKButton_Click" OnClientClick="confirmPayment()"/>
                                 ...
                                 <div class="test-btn">
                                        <asp:Button ID="btndraftPrint" runat="server" class="btn-btn" Style="background-color: #65C2DD" OnClick="btndraftPrint_Click" Text="Draft Print" />
                                    </div>
                                    <div class="test-btn">
                                    ...
                                    <div class="test-btn">                                     
                                      <asp:HyperLink class="btn-btn" style="background-color:#4CAF50;text-align:center" Height="25px" Width="100px" NavigateUrl="~/UI/Sale/ImportSalefromExcel.aspx" runat="server">Import Excel</asp:HyperLink>
                                     </div>
                                    
                                </div>
                                <div class="row" runat="server" id="div_d" visible="false">
                                   <div class="col-md-12">
                                    ...
                                    <Columns>
                                     ...
                                     <%--   <asp:BoundField HeaderText="Quantity" DataField="Quantity" DataFormatString="{0:n2}"/>
                                       --%>   
                                        ...
                                        <asp:BoundField HeaderText="Total Price" DataField="TotalPricegrid" DataFormatString="{0:n2}"/>
                ...
                <div class="container-fluid">
                  <div class="gridDiv table-responsive paddingsmall" runat="server">
                            ...
                            <div style="text-align: right" class="hiddencol">
                                ...
                                <asp:Label ID="Label53" runat="server" Font-Bold="True" Font-Size="Small" Text="Total Purchase Amount :"></asp:Label> <asp:TextBox ID="txtTotalVAT" Width="130px" runat="server" ReadOnly="True"></asp:TextBox>
                            <asp:Label ID="Label54" runat="server" Font-Bold="True" Font-Size="Small" Text="Total Purchase Amount :"></asp:Label> <asp:TextBox ID="txtTotalAIT" Width="130px" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                  ...
                  <asp:Panel ID="ModalParty" runat="server" Width="1000" CssClass="modal_custom" BorderWidth="2px" BorderColor="Blue">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 style="color:white;text-align:center;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font:bold;background-color:cornflowerblue;">Party Setup</h2>
                            </div>
                        </div>
                        <div class="row">
                       <div class="col-md-4">
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-7">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtParty" />
                       ...
                       <div class="col-md-4">
                            <div class="form-group form-group-sm">
                                ...
                                <%--<label class="col-sm-5 control-label">National Id No :</label>--%>
                                   <asp:label ID="lblNID" runat="server" CssClass="control-label col-sm-5"><span class="required">*</span>National Id No :</asp:label>
                                <div class="col-sm-7">
                       ...
                       <div class="col-md-4">
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-7">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtPrtaddress" TextMode="MultiLine" />
                     ...
                     <asp:Button ID="Button1" runat="server" Style="background-color: #D9534F; float: right" CssClass="btn-btn" Text="Close" />
                    <asp:Button ID="btnSubSave" runat="server"  Style="background-color: #4CAF50; float: right" CssClass="btn-btn" Text="Save" OnClick="btnSubSave_Click" />
                                     
                            </div>
                        </div>  
                    </asp:Panel>
                  <asp:Button ID="Button2" runat="server" class="hiddencol"/>
                    <ajaxToolkit:ModalPopupExtender ID="mpeParty" runat="server" TargetControlID="Button2"
                        BackgroundCssClass="modalPopup" PopupControlID="ModalParty" OkControlID="Button1" />
