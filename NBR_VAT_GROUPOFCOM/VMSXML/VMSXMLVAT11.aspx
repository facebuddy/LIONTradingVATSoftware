<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="VMSXML_VMSXML, App_Web_ritauljr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table align="center" class="brd_tbl_input">
        ...
        <tr>
            <td class="style1" align="right">
                <asp:Label ID="Labelx" runat="server" Text="কর মেয়াদ :"></asp:Label>
            </td>
            <td>
                <ww:jQueryDatePicker ID="dtpDateFrom" runat="server" Width="120px" DateFormat="dd/mm/yyyy"></ww:jQueryDatePicker>
                <asp:Label ID="Label1" runat="server" Text="হইতে"></asp:Label>
        ...
        <tr>
            <td class="style1" align="right">
                <asp:Label ID="Label2" runat="server" Text="ক্রেতার নাম :"></asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="drpOrgName" runat="server" Width="300px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="style1" align="right">
                <asp:Label ID="Label3" runat="server" Text="চালানপত্রের ক্রমিক সংখ্যা :"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtChallanId" runat="server" Width="50px"></asp:TextBox>
            </td>
        </tr>
        <tr>
