<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="VMSXML_VMSXML, App_Web_vp4bixng" %>
        ...
        <tr>
            ...
            <td>
                <ww:jQueryDatePicker ID="dtpFrom" runat="server" 
                        DateFormat="dd/MM/yyyy" Width="180px"></ww:jQueryDatePicker>
            </td>
        </tr>
        <tr>
            <td class="style1" align="right">
