<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Dashboard.Master" inherits="Admin_Dasboard, App_Web_1kre2rwf" %>
                ...
                <thead style="text-align: center; font-weight: bold">
                    ...
                    <td  colspan="2" style="color:#375623;font-weight:bolder">
                     Purchase
                        ...
                        <td> <asp:TextBox ID="dtpDateFrom" runat="server"  CssClass=".ajax__calendar_prev" DateFormat="MMMM,yyyy" style="text-align:center;color:black;background-color:#B5C6E7" AutoPostBack="true" OnTextChanged="dtpDateFrom_OnTextChanged"></asp:TextBox>
