<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_PriceDeclaration_Form1Ga, App_Web_pj2ymx2u" %>
...
<table align="center" class="brd_tbl_input">
        <tr>
            <td class="page_title" colspan="2">
                মূল্য ঘোষণাপত্র - (মূসক-১গ) <uc1:ReportsNav ID="ReportsNav1" runat="server" /></td>
        </tr>
        <tr>
            <td class="style1">
