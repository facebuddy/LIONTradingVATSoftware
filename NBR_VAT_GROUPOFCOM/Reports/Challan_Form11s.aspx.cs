...
{
    public partial class Challan_Form11s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            ...
            try
            {
                ...
                dataTable = this.objtrnsSaleMasterBLL.rptChallanForm11(this.objtrnsSaleMasterDAO);
                int num11 = 0;
