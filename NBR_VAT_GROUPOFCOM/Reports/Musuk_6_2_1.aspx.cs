...
{
    public partial class Musuk_6_2_1  : Page, IRequiresSessionState
    {
        ...
        protected HtmlGenericControl print;

        protected HiddenField hiddenPrantikJerQty;

        protected HiddenField hiddenPrantikJerValue;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            //if (!base.IsPostBack)
            //{
            //    Utility.fillAllItemN(this.ddlItem);
