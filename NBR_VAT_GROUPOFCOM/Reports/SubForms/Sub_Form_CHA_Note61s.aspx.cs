...
{
    public partial class Sub_Form_CHA_Note61s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart861DataSubReport = this.dbBLL.getVatReturnPart861DataSubReport(str1, str2, num7);
                if (vatReturnPart861DataSubReport != null && vatReturnPart861DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart861DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart861DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart861DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
