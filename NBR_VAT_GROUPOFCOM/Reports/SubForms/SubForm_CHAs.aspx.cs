...
{
    public partial class SubForm_CHAs : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart852DataSubReport = this.dbBLL.getVatReturnPart852DataSubReport(str1, str2, num7);
                if (vatReturnPart852DataSubReport != null && vatReturnPart852DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart852DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart852DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart852DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
