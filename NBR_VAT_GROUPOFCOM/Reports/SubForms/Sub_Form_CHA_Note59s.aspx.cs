...
{
    public partial class Sub_Form_CHA_Note59s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart859DataSubReport = this.dbBLL.getVatReturnPart859DataSubReport(str1, str2, num7);
                if (vatReturnPart859DataSubReport != null && vatReturnPart859DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart859DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart859DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart859DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
