...
{
    public partial class Sub_Form_K_Note_21s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart4DataSubReport = this.dbBLL.getVatReturnPart4DataSubReport(str1, str2, num7);
                if (vatReturnPart4DataSubReport != null && vatReturnPart4DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart4DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart4DataSubReport.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(vatReturnPart4DataSubReport.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(vatReturnPart4DataSubReport.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataSubReport.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataSubReport.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataSubReport.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
