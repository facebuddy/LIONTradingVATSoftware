...
{
    public partial class Sub_Form_CHA_Note53s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart853DataSubReport = this.dbBLL.getVatReturnPart853DataSubReport(str1, str2, num7);
                if (vatReturnPart853DataSubReport != null && vatReturnPart853DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart853DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart853DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart853DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
