...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SubForm_KSIMS.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.SubForm_KSIMS" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              আদর্শ হারের পণ্য (নোট ৪) 
                <%--রেয়াতযোগ্য নয় এরূপ পণ্য/সেবা (স্থানীয় ক্রয়) (নোট ১৯)-সাবফর্ম-ক--%>
            </p>
              <hr />
        </div>
                                ...
                                <div class="table-responsive">
                                   <%--<table border="1" class="table table-bordered" style="width: 100%; border-collapse: collapse">--%>
                                       <table class="allSolid" style="font-size:11px; width:100%; border-collapse: collapse;">
                                        ...
                                        <tbody>                                          
                                            <tr>
                                                <asp:Label runat="server" ID="lblReportHtmlSIMS" />
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
