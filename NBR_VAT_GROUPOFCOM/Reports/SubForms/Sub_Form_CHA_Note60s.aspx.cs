...
{
    public partial class Sub_Form_CHA_Note60s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart860DataSubReport = this.dbBLL.getVatReturnPart860DataSubReport(str1, str2, num7);
                if (vatReturnPart860DataSubReport != null && vatReturnPart860DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart860DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart860DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart860DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
