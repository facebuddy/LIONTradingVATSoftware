...
{
    public partial class SubForm_K_Note_7s : Page, IRequiresSessionState
    {
        ...
        private subfrom objnote7 = new subfrom();

      

        public SubForm_K_Note_7s()
        {
        }
        ...
        private void LoadReport()
        {
            ...
            try
            {
                ...
                DataTable vatReturnPart3DataRow7SubReport = this.dbBLL.getVatReturnPart3DataRow7SubReport(str1, str2, num7);
                if (vatReturnPart3DataRow7SubReport != null && vatReturnPart3DataRow7SubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart3DataRow7SubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart3DataRow7SubReport.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(vatReturnPart3DataRow7SubReport.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(vatReturnPart3DataRow7SubReport.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart3DataRow7SubReport.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart3DataRow7SubReport.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart3DataRow7SubReport.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart3DataRow7SubReport.Rows[i]["remarks"].ToString(), "</td>");
