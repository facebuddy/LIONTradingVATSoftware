...
{
    public partial class SubForm_K_Note_16s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart4DataRow16DataSubReport = this.dbBLL.getVatReturnPart4DataRow16DataSubReport(str1, str2, num7);
                if (vatReturnPart4DataRow16DataSubReport != null && vatReturnPart4DataRow16DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart4DataRow16DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart4DataRow16DataSubReport.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(vatReturnPart4DataRow16DataSubReport.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(vatReturnPart4DataRow16DataSubReport.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataRow16DataSubReport.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataRow16DataSubReport.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataRow16DataSubReport.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataRow16DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
