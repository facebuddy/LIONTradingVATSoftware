...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Subform_Note_26s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.Subform_Note_26s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
           <%-- <p class="printHeader" style="text-align: center;font-weight:bold;">Details of Note 27</p>--%>
             <p class="printHeader" style="text-align: center;font-weight:bold;">ডেবিট নোটের জন্য (নোট-২৬)</p>
              <hr />
        </div>
                                       ...
                                       <table class="allSolid" style="font-size:11px; width:100%; border-collapse: collapse;">
                                        <thead>
                                            <tr  style="border: 2px solid;">
                                                ...
                                                <th>বৃদ্ধিকারী সমন্বয়ের সহিত মূল্য</th>
                                                <th>বৃদ্ধিকারী সমন্বয়ের সহিত পরিমান</th>
                                                <th>বৃদ্ধিকারী সমন্বয়ের সহিত মূল্য সংযোজন কর</th>
                                                <th>বৃদ্ধিকারী সমন্বয়ের সহিত সম্পূরক শুল্ক</th>
