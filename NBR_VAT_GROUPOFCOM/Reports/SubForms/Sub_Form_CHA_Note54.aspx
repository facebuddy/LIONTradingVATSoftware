<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="Reports_SubForms_Sub_Form_CHA_Note54, App_Web_vvnwjv0y" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center">
             অপরিশোধিত মসুকের জন্য সুদ্ (নোট-৫৮) সাবফর্ম-ছ
            </p>
        </div>
