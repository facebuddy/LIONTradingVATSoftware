...
{
    public partial class Sub_Form_CHA_Note57s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart857DataSubReport = this.dbBLL.getVatReturnPart857DataSubReport(str1, str2, num7);
                if (vatReturnPart857DataSubReport != null && vatReturnPart857DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart857DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart857DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart857DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
