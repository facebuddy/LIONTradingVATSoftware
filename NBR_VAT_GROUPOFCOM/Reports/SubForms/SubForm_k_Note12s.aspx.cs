...
{
    public partial class SubForm_k_Note12s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable subFormKaNote12 = this.dbBLL.getSubFormKa_Note12(str1, str2, num7);
                if (subFormKaNote12 != null && subFormKaNote12.Rows.Count > 0)
                {
                    for (int i = 0; i < subFormKaNote12.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(subFormKaNote12.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(subFormKaNote12.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(subFormKaNote12.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", subFormKaNote12.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", subFormKaNote12.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", subFormKaNote12.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", subFormKaNote12.Rows[i]["remarks"].ToString(), "</td>");
