...
{
    public partial class SubForm_K_5s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart3SubReport5 = this.dbBLL.getVatReturnPart3SubReport5(str1, str2, num7);
                if (vatReturnPart3SubReport5 != null && vatReturnPart3SubReport5.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart3SubReport5.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart3SubReport5.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(vatReturnPart3SubReport5.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(vatReturnPart3SubReport5.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart3SubReport5.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart3SubReport5.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart3SubReport5.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart3SubReport5.Rows[i]["remarks"].ToString(), "</td>");
