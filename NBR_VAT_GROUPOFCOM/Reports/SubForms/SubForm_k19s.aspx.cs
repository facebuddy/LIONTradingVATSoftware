...
{
    public partial class SubForm_k19s : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart4DataturnoverSubReport = this.dbBLL.getVatReturnPart4DataturnoverSubReport(str1, str2, num7);
                if (vatReturnPart4DataturnoverSubReport != null && vatReturnPart4DataturnoverSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart4DataturnoverSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart4DataturnoverSubReport.Rows[i]["price"]);
                        num1 = Convert.ToDecimal(vatReturnPart4DataturnoverSubReport.Rows[i]["sd"]);
                        num2 = Convert.ToDecimal(vatReturnPart4DataturnoverSubReport.Rows[i]["vat"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataturnoverSubReport.Rows[i]["details"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataturnoverSubReport.Rows[i]["hs_code"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart4DataturnoverSubReport.Rows[i]["item_name"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart4DataturnoverSubReport.Rows[i]["remarks"].ToString(), "</td>");
