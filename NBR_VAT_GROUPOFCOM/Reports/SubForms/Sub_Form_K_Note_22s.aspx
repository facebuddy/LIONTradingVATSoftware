...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Sub_Form_K_Note_22s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.SubForms.Sub_Form_K_Note_22s" %>
    ...
    <div id="reportMain" class="container-fluid" style="padding: 2%;" runat="server" visible="true">
        <div class="row">
            <p style="text-align: center;font-weight:bold;font-size:14px;">
              রেয়াতযোগ্য নয় এমন পণ্য/সেবা (যে সকল করদাতা শুধুমাত্র অব্যাহতিপ্রাপ্ত/<br />
                        সুনির্দিষ্ট কর /আদর্শ হার ব্যতীত অন্যান্য হারে পণ্য/সেবা সরবরাহ করেন ) (নোট ২২) 
            </p>
              <hr />
        </div>
