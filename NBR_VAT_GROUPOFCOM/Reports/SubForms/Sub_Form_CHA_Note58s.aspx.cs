...
{
    public partial class Sub_Form_CHA_Note58s : Page, IRequiresSessionState
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                DataTable vatReturnPart858DataSubReport = this.dbBLL.getVatReturnPart858DataSubReport(str1, str2, num7);
                if (vatReturnPart858DataSubReport != null && vatReturnPart858DataSubReport.Rows.Count > 0)
                {
                    for (int i = 0; i < vatReturnPart858DataSubReport.Rows.Count; i++)
                    {
                        num = Convert.ToDecimal(vatReturnPart858DataSubReport.Rows[i]["amount"]);
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["tr_challan_no"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["bank_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["branch_name"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["date_challan"].ToString(), "</td>");
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["code_no"].ToString(), "</td>");
                        ...
                        str = string.Concat(str, "<td>", vatReturnPart858DataSubReport.Rows[i]["remarks"].ToString(), "</td>");
