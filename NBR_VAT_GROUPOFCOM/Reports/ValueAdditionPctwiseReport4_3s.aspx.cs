...
{
    public partial class ValueAdditionPctwiseReport4_3s : Page, IRequiresSessionState
    {
        ...
        public ValueAdditionPctwiseReport4_3s()
        {
        }
        ...
        private void LoadFullReport()
        {
            ...
            else
            {
                ...
                DataTable totalValueAddPct = this.objPDBLL.GetTotalValueAddPct(Convert.ToInt32(this.drpDeclaretionNo.SelectedItem.Value));
                ...
                if (dataTable2 != null && dataTable2.Rows.Count > 0)
                {
                    ...
                    for (int k = 0; k < dataTable2.Rows.Count; k++)
                    {
                        ...
                        obj = str;
                        objArray = new object[] { obj, "<td class='style14' align='left' style='width: 10% ;border-style:solid;border-width:1px; background-color: White'>", empty16, " ", '-', " ", str15, "</td>" };
                    ...
                    {
                        decimal num12 = Convert.ToDecimal(totalValueAddPct.Rows[0]["value_addtn_pct"]);
                        ...
                        {
                            obj = str;
                            objArray = new object[] { obj, "<td style='text-align:left; padding:2px;font-weight:bold'>Value Addition(%) : ", num12, "</td>" };
                            str = string.Concat(objArray);
                        }
                    }
                    str = string.Concat(str, "<tr>");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                Utilities.fillItemPriceWithDate(this.drpDeclaretionNo, "M");
