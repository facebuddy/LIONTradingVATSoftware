<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="Reports_sales_leisure_book, App_Web_y1tsx4fu" %>
                        ...
                        <div class="panel-body" style="padding-bottom: 5px">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:TextBox class="form-control" runat="server" ID="dtpToDate" DateFormat="dd/MM/yyyy" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="drpChallanNo" runat="server"  class="form-control select2">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-md-offset-10">
                                    <asp:Button ID="showBTN" runat="server" CssClass="btn-btn" Style="background-color: #3B7CB5;float: right" Text="Search" OnClick="showBTN_Click" />
