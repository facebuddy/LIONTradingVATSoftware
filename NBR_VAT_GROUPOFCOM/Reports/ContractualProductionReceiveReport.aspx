<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="Reports_ContractualProductionReceiveReport, App_Web_pj2ymx2u" %>
            ...
            <div class="container-fluid">
                <div class="panel panel-group">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading" style="text-align: center;  font-family:Tahoma; font-size:18px; font-weight: bold; height: 35px; padding-top: 0px">Receive /চুক্তিভিত্তিক উৎপাদনের চালানপত্র</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-7">
                                    <asp:DropDownList runat="server" ID="drpParty" CssClass="form-control select2" AutoPostBack="True" OnSelectedIndexChanged="drpParty_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <table style="border:none;width: 100%;">
                         ...
                         <div class="row" style=" font-size: 16px;">
                                 ...
                                 <p><b>Receive /চুক্তিভিত্তিক উৎপাদনের চালানপত্র </b> </p>  
