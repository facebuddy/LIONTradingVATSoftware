<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_Credit_Note_Form12, App_Web_o1josinq" %>
    ...
    <table align="center" class="brd_tbl_input">
        <tr>
            <td colspan="4" height="25" class="page_title">
                ক্রেডিট নোট <uc1:ReportsNav ID="ReportsNav2" runat="server" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style1" align="right">
                <asp:Label ID="Label1" runat="server" Text="ক্রেডিট নোটের ক্রমিক সংখ্যা :"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtCreditNoteNo" runat="server" Width="60px"></asp:TextBox>
            </td>
        </tr>
        <tr>
