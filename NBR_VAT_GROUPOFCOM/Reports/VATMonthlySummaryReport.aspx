<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_VATMonthlySummaryReport, App_Web_y1tsx4fu" %>
...
<table align="center" class="brd_tbl_input">
    <tr>
            <td colspan="2" height="25" class="page_title">
              VAT Monthly Summary Report  <uc1:ReportsNav ID="ReportsNav1" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="style1">
            ...
            <td>
                <ww:jQueryDatePicker ID="dtpDateFrom" runat="server" Width="300px" 
                    DateFormat="MM/yyyy"></ww:jQueryDatePicker>
            </td>
        </tr>
        <tr>
            <td class="style1">
