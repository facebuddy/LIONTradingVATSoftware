<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_SaleTypeWiseSummaryReport, App_Web_y1tsx4fu" %>
...
<table align="center" class="brd_tbl_input">
 <tr>
            <td colspan="2" height="25" class="page_title">
               Sale Type-wise Summary Report<uc1:ReportsNav ID="ReportsNav1" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="style1">
