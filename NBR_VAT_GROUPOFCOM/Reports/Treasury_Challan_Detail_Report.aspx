<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_Treasury_Challan_Detail_Report, App_Web_pj2ymx2u" %>
    ...
    <table align="center" class="brd_tbl_input">
        <tr>
            <td colspan="2" height="25" class="page_title">
                ট্রেজারী চালান বিস্তারিত রিপোর্ট <uc1:ReportsNav ID="ReportsNav1" runat="server" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style1" align="right">
                <asp:Label ID="Label4" runat="server" Text="চালানের কারণ :"></asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="drpChallanType" runat="server" Width="300px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
