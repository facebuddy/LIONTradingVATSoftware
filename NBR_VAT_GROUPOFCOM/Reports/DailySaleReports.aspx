<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="DailySaleReports.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.Reports.DailySaleReports" %>
                        ...
                        <div class="panel panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <%--zahid 21-07-2022--%>
                                <%--  <asp:LinkButton ID="btnExportToExcel" OnClientClick="exportReportToExcel()" runat="server" CssClass="btn btn-primary"><i class="fa fa-list"></i>  Excel</asp:LinkButton>--%>
                                    <%--zahid 21-07-2022--%>
                                </div>
