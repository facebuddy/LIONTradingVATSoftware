<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Reports_VatReturn, App_Web_o1josinq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-primary">
        <div class="panel-heading" style="text-align: center; font-size: 21px; font-weight: bold;
            ...
            মূল্য সংযোজন কর দাখিলপত্র (মূসক-৯.১)</div>
        <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
            <div class="row" style="padding-left: 0%; padding-right: 2%">
                <%-- <div class="col-sm-4" style="padding:0px" runat="server" visible="false">
   <fieldset class="scheduler-border-report" style="margin:0px; padding:0em">
       <legend title="" class="scheduler-border-report">কর মেয়াদ</legend>
         <div class="col-sm-6" style="padding:0px">
           <asp:Label ID="Label2" runat="server" Text="Date From:" class="present-address-lbl" style="margin-left:5%;margin-top:3px"></asp:Label>
           <ww:jQueryDatePicker ID="dtpDateFrom" runat="server" style="width:60%; margin-left:16%;height:27px" class="present-address-tb" DateFormat="dd/MM/yyyy"></ww:jQueryDatePicker>
           <asp:Label runat="server" ID="lblFromDate" Font-Bold="true" Font-Size="Small" ForeColor="Red" ></asp:Label>
          </div>
          <div class="col-sm-6" style="padding:0px">
             <asp:Label ID="Label1" runat="server" Text="Date To:" class="present-address-lbl" style="margin-left:5%;margin-top:3px"></asp:Label>
             <ww:jQueryDatePicker ID="dtpDateTo" runat="server" style="width:60%; margin-left:13.5%;height:27px" class="present-address-tb" DateFormat="dd/MM/yyyy"></ww:jQueryDatePicker>
                ...
                <div class="col-sm-4" style="padding: 0px; padding-left: 0%">
                    ...
                    <div class="col-sm-9" style="padding: 0px" runat="server" id="Div2" visible="false">
                        <fieldset class="scheduler-border-report" style="margin: 0px; padding: 0em">
                            ...
                            <div class="col-sm-6" style="padding: 0px">
                                <div class="col-sm-3" style="padding: 0px">
                                    <asp:Label runat="server" Text="Month:" /></div>
                                <div class="col-sm-3" style="padding: 0px">
            ...
            <div class="row" style="padding: 0%;">
                <div class="col-sm-6" style="padding: 0%;">
                    ...
                    <div id="Div1" class="col-sm-9" style="padding: 0px" runat="server" visible="false">
                        <fieldset class="scheduler-border-report" style="margin: 0px; padding: 0em">
                            ...
                            <div class="col-sm-6" style="padding: 0px">
                                <asp:Label ID="Label1" runat="server" Text="Date To:" class="present-address-lbl"
                                    Style="margin-left: 5%; margin-top: 3px"></asp:Label>
                ...
                <div class="col-sm-4" style="padding: 0%; margin-top: 15px; margin-left: 0px">
                    <asp:Label ID="Label6" runat="server" Style="margin-left: 8px" Text="বিগত করমেয়াদে কোনো কার্যক্রম সম্পন্ন হইয়াছে কি?  ">
                        <asp:Label ID="Label8" runat="server" Style="margin-left: 5px" Text="হ্যাঁ ">
                            <asp:CheckBox ID="ha" runat="server" /></asp:Label>
                        <asp:Label ID="Label9" Style="margin-left: 5px" runat="server" Text="না ">
                            <asp:CheckBox ID="na" runat="server" /></asp:Label>
                    </asp:Label>
                </div>
    ...
    <div>
        <asp:Button Style="float: right; margin-right: 2%;" CssClass="btn btn-success" runat="server"
            ID="btnSave" Text="Save" OnClick="btnSave_Click" Visible="false" />
        <asp:Button Style="float: right; margin-right: 2px;" CssClass="btn btn-success" runat="server"
            ID="btnCSV" Text="CSV" OnClick="btnCSV_Click" Visible="false" />
        <asp:Button Style="float: right; margin-right: 2px;" CssClass="btn btn-success" runat="server"
            ID="btnPrint" Text="Print" OnClientClick="return PrintPanel()" Visible="false" />
    </div>
</asp:Content>
