...
{
    public partial class CreditNoteReport : Page, IRequiresSessionState
    {
        ...
        void LoadApiReport(List<MushakReturnVw> list)
        {
            ...
            foreach (var item in list)
            {
                ...
                if (Convert.ToDecimal(item.sales_netamount) != new decimal(0))
                {
                    ...
                    num12 =Convert.ToDecimal(item.sales_vatamount);
                    //num12-Convert.ToDecimal(item.sales_vatamount);
                    str1 = string.Concat(str1, "<td style='text-align:right;padding:3px'>Sale Column: ", num12.ToString("N2"), "</td>");
                }
                else
                {
        ...
        private void loadReportData()
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dataTable.Rows.Count; i++)
                {
                    ...
                    {
                        decimal num1 = Convert.ToDecimal(dataTable.Rows[i]["sale_price"])- Convert.ToDecimal(dataTable.Rows[i]["sale_vat"]);
            ...
            if (num2 != -99)
            {
                ...
                if (dataTable.Rows.Count > 0)
                {
                    ...
                    for (int j = 0; j < dataTable.Rows.Count; j++)
                    {
                        ...
                        {
                            decimal num12 = Convert.ToDecimal(dataTable.Rows[j]["sale_price"])- Convert.ToDecimal(dataTable.Rows[j]["sale_vat"]);
                        ...
                        if (Convert.ToDecimal(dataTable.Rows[j]["note_price"]) != new decimal(0))
                        {
                            ...
                            decimal note_vat= Convert.ToDecimal(dataTable.Rows[j]["note_vat"]);
            ...
            else
            {
                ...
                if (dataTable.Rows.Count > 0)
                {
                    ...
                    for (int l = 0; l < dataTable.Rows.Count; l++)
                    {
                        ...
                        {
                            num = Convert.ToDecimal(dataTable.Rows[l]["sale_price"])- Convert.ToDecimal(dataTable.Rows[l]["sale_vat"]);
