<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="UI_Audit_RevenueStatement, App_Web_qhrdyc5n" %>
  ...
  <div class="container-fluid">
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align:center;  font-family:Tahoma; font-size:18px;font-weight:bold; height:30px; padding-top:0px">রাজস্ব বিবরণী (মূসক-১৮ মোতাবেক)</div>
          <div class="panel-body" style="padding-bottom:0px">
              <div class="row">
                 ...
                 <%-- <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                      <div class="form-group form-group-sm">
                         <asp:Button runat="server" ID="btnSearch" CssClass="btn btn-success btn-sm" Style="float:right" Text="Search" OnClick="btnSearch_OnClick" />
                      </div>
      ...
      <div runat="server" id="print">
         <div class="col-md-12">
             <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-4">
                     <center>
                     <asp:Label runat="server" class="control-label" style="font-size:16px; font-weight:bold">রাজস্ব বিবরণী (মূসক-১৮ মোতাবেক)</asp:Label>
                    </center>
                 </div>
                 <div class="col-sm-4"></div>
             </div>
        ...
        <div class="col-md-12">
            <div class="form-group form-group-sm" >
                <div class="table-responsive">
                        <table class="table" border="1" style="background:none;width:100%">
                            <thead>
                                <tr>
                                   <th rowspan="2" style="text-align:center">মাসের নাম</th>
                                    <th rowspan="2" style="text-align:center">প্রারম্ভিক জের</th>
                                    <th  colspan="3" style="text-align:center">গৃহীত রেয়াত</th>
                                    <th rowspan="2" style="text-align:center">মোট</th>
                                    <th rowspan="2"  style="text-align:center">প্রদেয় মূসক</th>
                                    <th rowspan="2"  style="text-align:center">সমন্বয় প্রদেয়</th>
                                    <th rowspan="2"  style="text-align:center">মোট প্রদেয়</th>
                                    <th rowspan="2"  style="text-align:center">ট্রেজারী জমা</th>
                                    <th rowspan="2"  style="text-align:center">সমাপনী জের</th>
                                 </tr>
                                <tr>
                                    <th style="text-align:center">আমদানি</th>
                                    <th style="text-align:center">স্থানীয়</th>
                                    <th style="text-align:center">সমন্বয় পাওনা</th>
                                </tr>
