<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="PriceDeclarationInformations.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Audit.PriceDeclarationInformations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align:center;  font-family:Tahoma; font-size:18px; font-weight:bold; height:30px; padding-top:0px">অনুমোদিত মূল্যভিত্তি ঘোষণাপত্র (মূসক-৪.৩ মোতাবেক)</div>
        ...
        <div runat="server" id="print" style="font-family:Nikosh">
         <div class="col-md-12">
             <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-4">
                     <center>
                     <asp:Label runat="server" class="control-label" style="font-size:16px; font-weight:bold">অনুমোদিত মূল্যভিত্তি ঘোষণাপত্র (মূসক-৪.৩ মোতাবেক)</asp:Label>
                    </center>
                 </div>
                 <div class="col-sm-4"></div>
             </div>
        ...
        <div class="col-md-12">
            <div class="form-group form-group-sm" >
                <div class="table-responsive">
                        <table class="table" border="1" style="background:none;width:100%; border-collapse:collapse">
                            <thead>
                                <tr>
                                    <th style="text-align:center">ক্র: নং</th>
                                    <th style="text-align:center">মূল্য ঘোষণা দাখিলের তারিখ</th>
                                    <th style="text-align:center">মূল্য অনুমোদনের তারিখ</th>
                                    <th style="text-align:center">পণ্যের নাম ও বিবরণ</th>
                                    <th style="text-align:center">বিক্রয় এর একক</th>
                                    <th style="text-align:center">কাঁচামাল এর মূল্য</th>
                                    <th style="text-align:center">মূল্য সংযোজন এর পরিমান</th>
                                    <th style="text-align:center">সংযোজনের হার </th>
                                    <th style="text-align:center">প্রস্তাবিত মূল্য</th>
                                    <th style="text-align:center">অনুমোদিত মূল্য (ভ্যাট ব্যাতিত)</th>
