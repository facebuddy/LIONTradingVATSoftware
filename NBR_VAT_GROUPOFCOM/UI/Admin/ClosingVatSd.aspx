<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="ClosingVatSd.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.ClosingVatSd" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="padding-top: 0px; padding-bottom: 5px">
                    <div class="row" style="margin-top:1%">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-sm">
                                    <label class="control-label col-sm-5 text-right"><span class="required" style="color:red"> * </span>Closing Balance :</label>
                                    <div class="col-sm-7">
                    ...
                    <div class="row">
                        <asp:GridView ID="gvvatsdClosing" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="closing_balance" DataFormatString="{0:n2}"
                                    HeaderText="Closing Balance" >
                                <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="adjust_pct" 
                                                HeaderText="Adjust (%)" >
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                 <asp:BoundField DataField="adjust_amount" DataFormatString="{0:n2}"
                                    HeaderText="Adjust Amount" >
                                <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
