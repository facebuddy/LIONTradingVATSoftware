...
namespace NBR_VAT_GROUPOFCOM.UI.Admin
{
    public partial class VDSIssue : Page, IRequiresSessionState
    {
        ...
        private NBR_VAT_GROUPOFCOM.BLL.VATReturnBLL objBL = new NBR_VAT_GROUPOFCOM.BLL.VATReturnBLL();
        ...
        {
          NBR_VAT_GROUPOFCOM.BLL. VATReturnBLL vATReturnBLL = new NBR_VAT_GROUPOFCOM.BLL.VATReturnBLL();
            int num = 0;
            if (this.drpParty.SelectedValue != "-99")
            {
        ...
        private void showreport(string certificate)
        {
            ...
            for (int i = 0; i < vDSDataByPartyChallanForRpt.Rows.Count; i++)
            {
                ...
                str = (Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["amount"]) != new decimal(0) ? string.Concat(str, "<td style='text-align:right'>",BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["pamount"]), num1), "</td>") : string.Concat(str, "<td style='text-align:right;padding:3px'>-</td>"));
                str = (Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["total_vat"]) != new decimal(0) ? string.Concat(str, "<td style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["total_vat"]), num1), "</td>") : string.Concat(str, "<td style='text-align:right;padding:3px'>-</td>"));
                if (vDSDataByPartyChallanForRpt.Rows.Count > 1 && i < vDSDataByPartyChallanForRpt.Rows.Count - 1)
                {
                    if (Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i]["item_id"]) != Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i + 1]["item_id"]) && Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i]["challan_id"]) == Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i + 1]["challan_id"]))
                    {
                        ...
                        {
                            str = string.Concat(str, "<td rowspan='2' style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]), num1), "</td>");
                    ...
                    {
                        str = string.Concat(str, "<td  style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]), num1), "</td>");
                        num = Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]);
                    }
                    else
                    {
            ...
            str = string.Concat(str, "<td style='text-align: right;font-weight:bold;'>", BLL.Utilities.RoundUpToWithString(num4, num1), "</td>");
            str = string.Concat(str, "<td style='text-align: right;font-weight:bold;'></td>");
            str = string.Concat(str, "<td style='text-align: right;font-weight:bold;'>", BLL.Utilities.RoundUpToWithString(num6, num1), "</td>");
            str = string.Concat(str, "</tr>");
        ...
        private void showreportOnButton()
        {
            ...
            for (int i = 0; i < vDSDataByPartyChallanForRpt.Rows.Count; i++)
            {
                ...
                str1 = (Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["amount"]) != new decimal(0) ? string.Concat(str1, "<td style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["pamount"]), num), "</td>") : string.Concat(str1, "<td style='text-align:right;padding:3px'>-</td>"));
                str1 = (Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["total_vat"]) != new decimal(0) ? string.Concat(str1, "<td style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["total_vat"]), num), "</td>") : string.Concat(str1, "<td style='text-align:right;padding:3px'>-</td>"));
                if (vDSDataByPartyChallanForRpt.Rows.Count > 1 && i < vDSDataByPartyChallanForRpt.Rows.Count - 1)
                {
                    if (Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i]["item_id"]) != Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i + 1]["item_id"]) && Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i]["challan_id"]) == Convert.ToInt16(vDSDataByPartyChallanForRpt.Rows[i + 1]["challan_id"]))
                    {
                        if (Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]) != new decimal(0))
                        {
                            str1 = string.Concat(str1, "<td rowspan='2' style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]), num), "</td>");
                    ...
                    {
                        str1 = string.Concat(str1, "<td  style='text-align:right'>", BLL.Utilities.RoundUpToWithString(Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]), num), "</td>");
                        num6 = Convert.ToDecimal(vDSDataByPartyChallanForRpt.Rows[i]["vds_amount"]);
                    }
                    else
                    {
            ...
            str1 = string.Concat(str1, "<td style='text-align: right;font-weight:bold;'>", BLL.Utilities.RoundUpToWithString(num1, num), "</td>");
            str1 = string.Concat(str1, "<td style='text-align: right;font-weight:bold;'></td>");
            str1 = string.Concat(str1, "<td style='text-align: right;font-weight:bold;'>", BLL.Utilities.RoundUpToWithString(num3, num), "</td>");
            str1 = string.Concat(str1, "</tr>");
