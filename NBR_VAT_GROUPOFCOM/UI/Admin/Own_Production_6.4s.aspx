<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Own_Production_6.4s.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.Own_Production_6__4s" %>
...
<%--    <link rel="stylesheet" href="/resources/demos/style.css">  
 ...
 .sGrid
        {
            background-color: #9d9689 !important;
        }
            ...
            <ContentTemplate>
                            ...
                            <div class="row">
                               ...
                               <%-- <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtPartyBIN" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>--%>
                            <div class="col-md-4">
                         ...
                         <div class="col-sm-4" style="padding: 0px"><asp:Button runat="server" style="width:122px;float:right;margin-right:15px" ID="btnShowIngredience" OnClick="btnShowIngredience_OnClick" Text="Show Ingredience" CssClass="test-btn-primary" /></div>--%>
                            ...
                            <div class="row" style="margin-top: 10px; padding: 5px">
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:Label runat="server" ID="Label9" Text="avl qnt: " Style="color: #008000;font-weight:bold;margin-left: -35px;" /><asp:Label Style="color: #008000;font-weight:bold" runat="server" ID="avlQuantity" />
                                </div>
                                <div class="test-label">
                                    ...
                                    <div class="panel-body">
                                        <div class="">
                                            <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="False"
                                                ...
                                                BackColor="#29a531" BorderColor="#29a531"
                                        ...
                                        <div class="">
                                            <asp:GridView ID="gvIngredience" runat="server" AutoGenerateColumns="False" CssClass="sGrid"
                                                ...
                                                BackColor="#29a531" BorderColor="#29a531" OnRowDataBound="gvIngredience_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Item" DataField="ItemName" />
                                                    <asp:BoundField HeaderText="Unit" DataField="UnitName" />
                                                    <asp:BoundField HeaderText="Per Quantity" DataField="PreQuantity" />
                                                    <asp:TemplateField HeaderText="Total Quantity">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="received_quantity" runat="server" Text='<%# Eval("Quantity") %>' Style="width: auto"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                ...
                <div id="cpPrint" class="container-fluid" style="margin-top: 2%;font-family:Nikosh" runat="server" visible="true">
                    <div class="row" style="font-size:16px">
                        ...
                        <p>
                            <center>
                    <%--<b style="margin-left: 9%;">সত্ত্বাধীকারীর সরবরাহস্থল হইতে উৎপাদনের জন্য প্রেরিত উপকরণ এর চালানপত্র </b><strong style="text-align: center; border: 1px solid gray; float: right">মূসক-১১গ</strong>--%>
                                <%--<b style="margin-left: 9%;">সত্ত্বাধীকারীর সরবরাহস্থল হইতে উৎপাদনের জন্য প্রেরিত উপকরণ এর চালানপত্র </b><strong style="text-align: center; border: 1px solid gray; float: right">মূসক-৬.৪</strong>--%>
                                <b style="margin-left: 9%;">Issue / উৎপাদনের চালানপত্র </b><%--<strong style="text-align: center; border: 1px solid gray; float: right">মূসক-৬.৪</strong>--%>
                    </center>
                            <p>
                            </p>
                          <%--  <p style="text-align: center">
                                [বিধি ৪০ এর উপ-বিধি (১) এর দফা (ঘ) দ্রষ্টব্য]</p>
                            <p>--%>
                            <p>
                            </p>
                            <p>
