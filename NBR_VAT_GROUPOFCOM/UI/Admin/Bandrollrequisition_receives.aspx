<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="Bandrollrequisition_receives.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.Bandrollrequisition_receives" %>
                ...
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading" style="text-align: center;font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">
                            Bandroll Requisition Receive Form
                        </div>
                            ...
                            <div class="row">
                                  <div class="col-md-4">
                                   ...
                                   <%--  <label class="col-sm-5 control-label">Challan No :</label>--%>
                                         <label ID="label211" class="control-label col-sm-5"><span class="required"> * </span>Provided Challan No :</label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="drpProvidedChallan" CssClass="form-control" Style="height: 27px" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="drpProvidedChallan_SelectedIndexChanged" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                           ...
                                           <%-- <label class="col-sm-5 control-label">Finish Product(Pr) :</label>--%>
                                            ...
                                            <div class="col-sm-7">
                                                <asp:DropDownList ID="drpFilterType" Enabled="false" CssClass="form-control select2" runat="server" Style="height: 27px; text-align: left" AutoPostBack="true" >
                                                    ...
                                                    <asp:ListItem Value="0">Without Filter</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <label>Avl.Quantity:</label>
                                            <asp:Label runat="server" ID="lblavlQuantity"></asp:Label>
