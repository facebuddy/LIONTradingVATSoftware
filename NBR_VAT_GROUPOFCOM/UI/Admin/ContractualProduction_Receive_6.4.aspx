<%@ page title="সত্ত্বাধিকারীর সরবরাহ স্থল থেকে উৎপাদিত পণ্য গ্রহণ" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="ContractualProduction_Receive_6_4, App_Web_znns2ib5" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
 ...
 <%--   <link href="../../Scripts/Select2CSS/select2.min.css" rel="stylesheet" type="text/css"/>--%>
   ...
   <%-- <script src="../../Scripts/select2.full.min.js"></script>--%>
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<style>table.allSolid { border: 1.5px solid black;font-size:10px;} table.allSolid th { border: 1.5px solid black;}table.allSolid td { border: 1.5px solid black;}</style>');
    ...
    <div class="container-fluid">
            ...
            <ContentTemplate>
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading" style="text-align: center;font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">Receive / চুক্তিভিত্তিক উৎপাদনের চালানপত্র (মূসক-৬.৪) </div>
                        <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
                           ...
                           <%-- <div class="row" style="margin-top: 5px; background-color: #E0EBF5">
                            ...
                            <%--<div class="row" style="margin-top: 1%">
                                <div class="col-sm-4" style="padding: 0px">
                                    <div class="col-sm-3" style="padding: 0px">
                                        <asp:Label ID="Label3" Style="margin-top: 2px;" CssClass="present-address-lbl"
                                            runat="server" Text="Party Name:"></asp:Label>
                                    </div>
                                    <div class="col-sm-5" style="padding: 0px">
                                        <asp:DropDownList ID="drpParty" runat="server" CssClass="present-address-tb" Style="width: 125%; height: 27px; margin-left: -29px; text-align: left"
                                            AutoPostBack="True" OnSelectedIndexChanged="drpParty_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-2" style="padding: 0px">
                                        <asp:Button ID="btnAddParty" runat="server" OnClick="btnAddParty_Click" Text="New"
                                            Style="width: 60px; height: 27px; margin-left: 11px" Visible="false" />
                                    </div>
                                    <div class="col-sm-4" style="padding: 0px">
                                ...
                                <div class="col-sm-6" style="padding: 0px">
                                    <div class="col-sm-1" style="padding: 0px">
                                        <asp:Label ID="Label4" Style="margin-left: 35px; margin-top: 2px;" runat="server"
                                            class="present-address-lbl" Text="Address:"></asp:Label>
                                    </div>
                                    <div class="col-sm-11" style="padding: 0px">
                                        <asp:TextBox Style="height: 27px; width: 50%; margin-left: 46px" class="present-address-tb"
                                            ID="txtAddress" runat="server" placeholder="address here"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-2" style="padding: 0px">
                                    <div class="col-sm-1" style="padding: 0px">
                                        <asp:Label ID="Label12" Style="margin-top: 2px; margin-left: 15px" runat="server" Text="BIN:" class="present-address-lbl"></asp:Label>
                                    </div>
                                    <div class="col-sm-11" style="padding: 0px">
                                        <asp:TextBox ID="txtPartyBIN" runat="server" Style="width: 75%; margin-left: 30px; height: 27px"
                            ...
                            <%--<div class="row" style="margin-top: 1%">
                                ...
                                <div class="col-sm-2" style="padding: 0px" runat="server" id="discard" visible="false">
                                    <div class="col-sm-5" style="padding: 0px">
                                        <asp:Label ID="lblDiscardReason" CssClass="present-address-lbl" Style="margin-left: 5px; margin-top: 4px;"
                                            runat="server" Text="Discard Reason:" Visible="true"></asp:Label>
                                    </div>
                                    <div class="col-sm-5" style="padding: 0px">
                                        <asp:DropDownList ID="drpDiscardReason" CssClass="present-address-tb" runat="server"
                                ...
                                <div class="col-sm-4" style="padding: 0px">
                                    <asp:Label ID="Label32" CssClass="present-address-lbl" runat="server" Style="margin-left: 9px; float: left; margin-top: 2px;"
                                        Text="Challan Date:"></asp:Label>
                                    <asp:TextBox ID="txtChallanDate" CssClass="present-address-tb" runat="server" Style="width: 43%; margin-left: 14px; float: left; height: 27px"
                                    ...
                                    <asp:DropDownList ID="drpChDtHr" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True" OnSelectedIndexChanged="drpChDtHr_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpChDtMin" CssClass="present-address-tb" runat="server" Style="width: 50px; float: left; height: 27px"
                                        AutoPostBack="True" OnSelectedIndexChanged="drpChDtMin_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div class="col-sm-3" style="padding: 0px">
                                    <div class="col-sm-6" style="padding: 0px">
                                        <asp:Label runat="server" Text="Receive Scroll No:" Visible="true" Style="margin-left: 33px;"></asp:Label>
                                    </div>
                                    <div class="col-sm-6" style="padding: 0px">
                            ...
                            <div class="row" style="margin: 10px; padding: 0px">
                                <div class="test-label">
                                    ...
                                    <asp:DropDownList ID="drpRole" runat="server" Style="width: 100px; text-align: left" CssClass="detail-role select2" OnSelectedIndexChanged="drpRole_SelectedIndexChanged"
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:DropDownList ID="drpCategory" runat="server" Style="width:100px;text-align: left" CssClass="category select2" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged"
                                        Enabled="true" AutoPostBack="True">
                                    </asp:DropDownList>
                                </div>
                                <div class="test-label">
                                    <asp:Label ID="Label15" runat="server" Text="Sub Cat:"></asp:Label><br />
                                    <asp:DropDownList ID="drpSubCategory" Style="width:100px;text-align: left" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpSubCategory_SelectedIndexChanged"
                             ...
                             DelimiterCharacters=";, :" ShowOnlyCurrentWordInCompletionListItem="true">
                               ...
                               <%-- </div>--%>
                                <div class="test-label">
                                    <asp:Label ID="Label16" runat="server" Text="Item Name:" Style="width:150px;margin-left: 0px;" /><br />
                              ...
                              <asp:TextBox ID="txtBatchNo" CssClass="hs-code" runat="server" Style="width: 80px"></asp:TextBox>
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:Label runat="server" ID="lblAvailableQuantity" style="color: #008000;font-weight:bold"/>
                                ...
                                <div class="test-label">
                                    ...
                                    <asp:DropDownList ID="drpUnit" CssClass="unit" runat="server" Style="width: 80px" OnSelectedIndexChanged="drpUnit_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                           ...
                           <asp:Label ID="lblfxdVT" runat="server" Text="" />         <asp:Label ID="lblSaleVat" runat="server" Text="" /><asp:Label ID="Label9" runat="server" Text="%"></asp:Label>
                                ...
                                <div class="test-label">
                                    <asp:Label ID="Label43" runat="server" Text="SD:" Style="margin-left: 1px;" /><br />
                                ...
                                <div class="test-btn">
                                    <asp:Button ID="printBTN" runat="server" class="btn-btn" OnClick="btnPrint_Click" Text="Show Report" Style="background-color:#5CB85C;margin-top: 17px; " />
                                </div>
                                <div class="test-btn">
                                    <asp:Button ID="btnAdd" runat="server" class="btn-btn" style="background-color:#B681B7;margin-top: 17px" OnClick="btnAddItem_Click" Text="Add Item"  />
                                </div>
                                <div class="test-btn">
                                    <asp:Button ID="btnSave" runat="server" style="background-color:#4CAF50;margin-top: 17px" class="btn-btn" Text="Save" OnClick="btnSave_Click"/>
                                </div>
                                <div class="test-btn">
                                    <asp:Button ID="btnClear" runat="server" style="background-color: #4CAF50;margin-top: 17px" class="btn-btn" OnClick="btnClear_Click" Text="Refresh"/>
                                </div>
                                            ...
                                            <asp:GridView ID="gvMainItem" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Item" DataField="ItemName" HeaderStyle-ForeColor="White"/>
                                                      <asp:BoundField HeaderText="Batch No" DataField="Batch_no" HeaderStyle-ForeColor="White" />
                                                     <asp:BoundField HeaderText="Mfg. Date" DataField="MfgDate" HeaderStyle-ForeColor="White" DataFormatString="{0:dd-MMM-yyyy}"/>
                                                     <asp:BoundField HeaderText="Expiry Date" DataField="ExpiryDate" HeaderStyle-ForeColor="White" DataFormatString="{0:dd-MMM-yyyy}"/>
                                                    ...
                                                    <asp:BoundField HeaderText="Used Quantity" DataField="Quantity" HeaderStyle-ForeColor="White"/>
                                                    <asp:BoundField HeaderText="Unit" DataField="UnitName" HeaderStyle-ForeColor="White"/>
                                                    <asp:BoundField HeaderText="Unit Price" DataField="SaleUnitPrice" HeaderStyle-ForeColor="White"  DataFormatString="{0:n2}"/>
                                                    <asp:BoundField HeaderText="Vat" DataField="SaleVat" HeaderStyle-ForeColor="White"  DataFormatString="{0:n2}"/>
                                                    <asp:BoundField HeaderText="SD" DataField="SaleSD" HeaderStyle-ForeColor="White"  DataFormatString="{0:n2}"/>
                                                    <asp:BoundField HeaderText="Vatable Price" DataField="SaleVatablePrice" HeaderStyle-ForeColor="White"  DataFormatString="{0:n2}"/>
                                                    ...
                                                    <asp:BoundField HeaderText="Remark" DataField="Remark" HeaderStyle-ForeColor="White"/>
                                                </Columns>
        ...
        <p style="text-align:center">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</p>
                        ...
                        <p style="text-align:right; padding:5px;font-size:20px"><b style="border:1px solid gray;margin-right: 17px;">মূসক-৬.৪</b></p>
                         <p style="text-align:center;font-size:20px"><strong>চুক্তিভিত্তিক উৎপাদনের চালানপত্র</strong></p>
...
<%--commented above and updated below to update font size smaller and nikosh by sabbir 11/2/21--%>
            ...
            <div style="font-size:16px">
                ...
                <table style="border:none;width: 100%;">
                         <tr>
                             ...
                             <td> <img src="../../Images/bdlogo.png" style="height:40px;" ></img></td>
                              <td style="padding-left:50px;">
                                  ...
                                  <p style="text-align:center;font-size:12px; margin:2px;margin-top:10px;"><strong>Receive / চুক্তিভিত্তিক উৎপাদনের চালানপত্র</strong></p>
                                  <p style="text-align:center;font-size:12px; margin:2px;">[বিধি ৪০ এর উপ-বিধি (১) এর দফা (ঘ) দ্রষ্টব্য]</p>
                               </td>

                               <td>
                                   <p style="text-align:right;">
                                   <b style="border:1px solid gray;font-size:12px;">মূসক-৬.৪</b></p> 
                                </td>
                           </tr>
                 </table> 
                    ...
                    <div class="row" style="margin-top: 2%">
                        ...
                        <table  class="allSolid" border="1" style="width:100%;border-collapse: collapse;">
                            <tr>
