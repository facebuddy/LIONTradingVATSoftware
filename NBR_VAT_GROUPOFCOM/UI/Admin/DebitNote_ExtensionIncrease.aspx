...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="DebitNote_ExtensionIncrease.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.DebitNote_ExtensionIncrease" %>
    ...
    <div class="container-fluid" style="padding-right: 0%; padding-left: 0%">
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center; font-family:Tahoma; font-size:18px; font-weight: bold; height: 30px; padding-top: 0px">বিবিধ সমন্বয়ের জন্য...বৃদ্ধিকারী সমন্বয়</div>
                <div class="panel-body" style="padding-top: 0px; padding-bottom: 2px">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-sm-4" style="padding: 0px">
                                <div class="col-sm-3" style="padding: 0px">
                                    <asp:Label ID="Label1" Style="margin-left: 51%" runat="server" Text="নাম:"></asp:Label>
                                </div>
                    ...
                    <div class="row"  style="margin-top:15px">
                       <%-- <div class="col-sm-3" style="padding:0px">
                            <asp:Label ID="Label18" runat="server" Text="ডেবিট নোট নম্বর:" CssClass="present-address-lbl"  style="margin-top:3px"/>
                            <asp:TextBox runat="server" ID="txtDebitNot" CssClass="present-address-tb" style="width:65%;height:27px;margin-left:30%" Enabled="false"/>
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-7">
                                    <asp:TextBox runat="server" type="text" class="form-control" ID="txtDebitNot"></asp:TextBox>
                                    <asp:Label ID="debitNoteId" runat="server" Visible = "false" />
                                    <asp:HiddenField ID = "hdBookId" runat="server" />
                                    <asp:HiddenField ID = "hdPageNo" runat="server" />
                                </div>
                       ...
                       <%-- <div class="col-sm-3" style="padding:0px">
                            ...
                            <asp:DropDownList runat="server" ID="drpOAReason" CssClass="present-address-tb" style="width:65%;height:27px;margin-left:28%" placeholder="সমন্বয়ের  ঘটনাগুলো লিখুন" OnSelectedIndexChanged="drpOAReason_IndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>--%>
                        <div class="col-md-3">
                            <div class="form-group form-group-sm">
                    ...
                    <div class="row" style="margin-top: 5px">
                       <%-- <div class="col-sm-3" style="padding: 0px">
                            <asp:Label runat="server" Text="বিষয়:" CssClass="present-address-lbl" Style="margin-left: 18.6%; margin-top: 3px" />
                      ...
                      <%--  <div class="col-sm-3" style="padding: 0px">
                       ...
                       <%-- <div class="col-sm-3" style="padding: 0px">
                            <asp:Label ID="Label17" runat="server" Text="টাকার পরিমান:" CssClass="present-address-lbl" Style="" />
                   ...
                   <div class="col-sm-3">
                    ...
                    <%--25-Dec-2019 end--%>
                     <%--07-Jan-2020 start by the instruction of ruhul vai--%>
                ...
                <%--fileupload_body--%>
                    ...
                    <div class="row" style="margin-top: 5px">
                        ...
                        <asp:Button ID="btnRefresh" runat="server" CssClass="btn btn-info" Style="float: right;background-color:#4CAF50;" Text="Refresh" OnClick="btnRefresh_Click" />

<%--                        <asp:Button ID="btnRefresh" runat="server" CssClass="btn btn-info" Style="float: right" Text="Refresh" OnClick="btnRefresh_Click" />
