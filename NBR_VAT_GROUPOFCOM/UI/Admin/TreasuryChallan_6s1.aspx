...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="TreasuryChallan_6s1.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Admin.TreasuryChallan_6s1" %>
                        ...
                        <div class="col-sm-12" style="padding:0px">
                         <div class="col-sm-12">
                            ...
                            <div class="col-sm-9">
                                ...
                                <asp:RadioButton ID="radio_vat_9_1" Checked="True" Text="VDS" GroupName="vat_type" runat="server" OnCheckedChanged="radio_vat_9_1_CheckedChanged" AutoPostBack="true" onclick="clearChkBox(this)" />
