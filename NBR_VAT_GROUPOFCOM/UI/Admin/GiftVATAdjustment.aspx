<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="UI_Admin_GiftVATAdjustment, App_Web_bxnrqbtx" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center; font-family: Tahoma; font-size: 18px; font-weight: bold; height: 30px; padding-top: 0px">Gift/Discount সমন্বয়</div>
                <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
                      ...
                      <div class="row" style="margin: 10px">
                       ...
                       <div class="col-md-6" runat="server" id="dvTotal">
