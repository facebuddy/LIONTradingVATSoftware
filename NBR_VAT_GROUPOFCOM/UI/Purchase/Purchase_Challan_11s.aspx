...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="LocalPurchases.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Purchase.LocalPurchases" %>

<%@ Register Src="~/UserControls/Item.ascx" TagPrefix="uc1" TagName="Item" %>
                                 ...
                                 <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                           <asp:TextBox ID="txtrefChallanDate" CssClass="form-control" Style="width: 50%; float: left" runat="server" DateFormat="dd/MM/yyyy"></asp:TextBox>
                                         ...
                                         <asp:Panel ID="ModalPanel" runat="server" Width="800" CssClass="modal_custom" BorderWidth="2px" BorderColor="Blue">
                                            <table style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="chkCredit" runat="server"  style="margin-left:10px" Text="Credit" Visible="false" onclick="chkCheckedEvent(this);" />
                                                    </td>
