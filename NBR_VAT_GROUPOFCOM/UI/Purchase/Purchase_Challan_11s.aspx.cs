...
{
    public partial class LocalPurchases : Page, IRequiresSessionState
    {


      //  protected MsgBoxss MsgBoxs=new MsgBoxss();
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            {
               NBR_VAT_GROUPOFCOM.BLL.Utility.InsertErrorTrack(exception.Message, "Purchase_Challan_6.3", "btnAddItem_Click");
            }
        }
        ...
        protected void btnAddParty_Click(object sender, EventArgs e)
        {
            try
            {
                base.Response.Redirect("~/UI/Others/Add_Trans_Party.aspx");
            }
            catch (Exception exception)
            {
                ...
                if (this.MasterValidation())
                {
                    ...
                    if (purchaseMasterDAO != null)
                    {
                        ...
                        if (arrayLists == null || arrayLists.Count == 0)
                        {
                            ...
                            string meesage = "Please insert detail data properly";
                        ...
                        else
                        {
                            ...
                            {
                                string message = "Purchase Infomation Successfully Saved.";
                                ClientScript.RegisterStartupScript(this.GetType(), "successalert", "successalert('" + message + "');", true);
                                // ClientScript.RegisterStartupScript(this.GetType(), "successalert", "successalert('Successfullly Saved!');", true);
                                this.MsgBoxs.AddMessage("Purchase Infomation Successfully Saved.",MsgBoxs.enmMessageType.Success);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.MasterValidation())
                {
                    ...
                    if (purchaseMasterDAO != null)
                    {
                        ...
                        {
                            bool flag = false;
                            if (this.btnSave.Text == LocalPurchases.enmBtnText.Save.ToString())
                            {
                                ...
                                else
                                {
                                    ...
                                    // this.MsgBoxs.AddMessage("Purchase Information Successfully Saved.",MsgBoxs.enmMessageType.Success);
                                    this.itemId.Text = "";
                                    this.ClearAllControlsValue();
                                    this.ClearCheckBox();
            ...
            {
                Utility.InsertErrorTrack(exception.Message, "Purchase_Challan_6.3", "btnSave_Click");
            }
        }
        ...
        protected void btnShowDataByVoucher_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.MsgBoxs.AddMessage(" Please Select Any GRN No OR Voucher No ",MsgBoxs.enmMessageType.Attention);
                }
            }
            catch (Exception exception)
            {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception exception3)
            {
                ...
                Utilities.KillExcelFileProcess();
                Utility.InsertErrorTrack(exception2.Message, "LocalPurchase", "btnUpload_Click");
            }
            Utilities.KillExcelFileProcess();
        }
        ...
        private void fillDetailProperties()
        {
            ...
            try
            {
                ...
                purchaseDetailDAO.RemarksDetail = Utility.ReplaceQuotes(this.remarks2.Text);
                ...
                if (this.btnAdd.Text.Trim() != LocalPurchases.enmBtnText.Update.ToString())
                {
        ...
        private PurchaseMasterDAO GetInserMasterValues(PurchaseMasterDAO objMDAO)
        {
            try
            {
                ...
                objMDAO.ChallanNo = Utility.ReplaceQuotes(this.txtChallanNo.Text);
                ...
                objMDAO.ScrollNo = Utility.ReplaceQuotes(this.txtScrollNo.Text);
                objMDAO.VehicleTypeM = 7;
                objMDAO.VehicleTypeD = Convert.ToInt16(this.drpVehicleType.SelectedValue);
                objMDAO.VehicleNo = Utility.ReplaceQuotes(this.txtVehicleNo.Text);
                objMDAO.UserIdInsert = Convert.ToInt16(this.Session["EMPLOYEE_ID"]);
                if (!this.drpParty.Enabled)
                {
                    objMDAO.IsNewParty = true;
                    objMDAO.PartAddress = Utility.ReplaceQuotes(this.txtAddress.Text);
                    objMDAO.PartyTIN = Utility.ReplaceQuotes(this.txtPartyBIN.Text);
                }
                else
                {
                ...
                objMDAO.UltimateDestination = Utility.ReplaceQuotes(this.txtDestination.Text);
                objMDAO.Remarks = Utility.ReplaceQuotes(this.txtRemarks.Text);
        ...
        private void GetInsertExcelMasterValues()
        {
            try
            {
                ...
                foreach (PurchaseDetailDAO arrayList in arrayLists)
                {
                    ...
                    purchaseMasterDAO.ScrollNo = Utility.ReplaceQuotes(this.txtScrollNo.Text);
                    purchaseMasterDAO.VehicleTypeM = 7;
                    purchaseMasterDAO.VehicleTypeD = Convert.ToInt16(this.drpVehicleType.SelectedValue);
                    purchaseMasterDAO.VehicleNo = Utility.ReplaceQuotes(this.txtVehicleNo.Text);
                    ...
                    purchaseMasterDAO.UltimateDestination = Utility.ReplaceQuotes(this.txtDestination.Text);
                    purchaseMasterDAO.Remarks = Utility.ReplaceQuotes(this.txtRemarks.Text);
        ...
        {
            NBR_VAT_GROUPOFCOM.BLL.CurrentAccountBLL currentAccountBLL = new NBR_VAT_GROUPOFCOM.BLL.CurrentAccountBLL();
            ...
            DateTime now = DateTime.Now;
            DateTime formattedDateMMDDYYYY = Utility.GetFormattedDateMMDDYYYY(now.ToString("dd/MM/yyyy"));
        ...
        private bool MasterValidation()
        {
            ...
            {
                this.MsgBoxs.AddMessage("Registration type must be selected",MsgBoxs.enmMessageType.Attention);
                return false;
            }
            if (this.drpParty.Enabled && this.drpParty.SelectedValue == "-99")
            {
                this.MsgBoxs.AddMessage("Please select a party",MsgBoxs.enmMessageType.Attention);
                return false;
            }
            if (this.txtChallanNo.Text.Length == 0)
            {
                this.MsgBoxs.AddMessage("Please insert challan no.",MsgBoxs.enmMessageType.Attention);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!base.IsPostBack)
                {
                    ...
                    DataTable dataTable = this.permissionBLL.CheckPaymentMethodPermision(str1, str2, "/UI/Purchase/LocalPurchases.aspx");
                    if (dataTable != null && dataTable.Rows.Count > 0)
                    {
        ...
        private void SDLastUpdatedBalance()
        {
            ...
            string str = this.Session["ORGANIZATION_ID"].ToString();
            today = Utility.GetFormattedDateMMDDYYYY("01/01/2010");
            formattedDateMMDDYYYY = Utility.GetFormattedDateMMDDYYYY("01/01/2030");
        ...
        {
            this.btnSave.Text = LocalPurchases.enmBtnText.Save.ToString();
        }
        ...
        {
            this.btnAdd.Text = LocalPurchases.enmBtnText.Update.ToString();
        }

        private void setMainAddMode()
        {
            this.btnSave.Text = LocalPurchases.enmBtnText.Save.ToString();
            this.btnClear.Text = LocalPurchases.enmBtnText.Clear.ToString();
        }

        private void setMainUpdateMode()
        {
            this.btnSave.Text = LocalPurchases.enmBtnText.Update.ToString();
            this.btnClear.Text = LocalPurchases.enmBtnText.Cancel.ToString();
        }
        ...
        protected void txtUnitPrice_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                 ...
                 // NBR_VAT_GROUPOFCOM.MessageBox.Show(this.Page, "Here is my message");
                   // this.MsgBoxs.AddMessage(string.Concat("Unit Price Difference is ", num2.ToString("0.00"), "%"),MsgBoxs.enmMessageType.Attention);
                   // this.MsgBoxs.AddMessage(string.Concat("Unit Price Difference is ", num2.ToString("0.00"), "%"), MsgBoxss.enmMessageType.Attention);
                }
        ...
        private bool Validation()
        {
            ...
            {
                this.MsgBoxs.AddMessage("Quantity is mandatory", MsgBoxs.enmMessageType.Attention);
            ...
            {
                this.MsgBoxs.AddMessage("Unit Price is mandatory",MsgBoxs.enmMessageType.Attention);
                this.txtPurchaseUnitPrice.Focus();
                return false;
            }
            if (this.chkReusable.Checked && this.txtPurchaseUnitPrice.Text == "")
            {
                this.MsgBoxs.AddMessage("Unit Price must be 0.",MsgBoxs.enmMessageType.Attention);
                this.txtPurchaseUnitPrice.Focus();
                return false;
            }
            if (this.drpItem.SelectedValue == "-99")
            {
                this.MsgBoxs.AddMessage("Select an item.",MsgBoxs.enmMessageType.Attention);
                this.drpItem.Focus();
                return false;
            }
            if (!this.chkExcel.Checked)
        ...
        public static class WrittenNumerics
        {
            ...
            static WrittenNumerics()
            {
                ...
                LocalPurchases.WrittenNumerics.ones = strArrays;
                string[] strArrays1 = new string[] { "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen", "Seventeen", "Eighteen", "Nineteen" };
                LocalPurchases.WrittenNumerics.teens = strArrays1;
                string[] strArrays2 = new string[] { "Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
                LocalPurchases.WrittenNumerics.tens = strArrays2;
                string[] strArrays3 = new string[] { "", " Thousand", " Million", " Billion" };
                LocalPurchases.WrittenNumerics.thousandsGroups = strArrays3;
            }

            public static string DateToWritten(DateTime date)
            {
                return string.Format("{0} {1} {2}", LocalPurchases.WrittenNumerics.IntegerToWritten(date.Day), date.ToString("MMMM"), LocalPurchases.WrittenNumerics.IntegerToWritten(date.Year));
            }
            ...
            private static string FriendlyInteger(int n, string leftDigits, int thousands)
            {
                ...
                if (n < 10)
                {
                    str = string.Concat(str, LocalPurchases.WrittenNumerics.ones[n]);
                }
                else if (n < 20)
                {
                    str = string.Concat(str, LocalPurchases.WrittenNumerics.teens[n - 10]);
                }
                else if (n >= 100)
                {
                    str = (n >= 1000 ? string.Concat(str, LocalPurchases.WrittenNumerics.FriendlyInteger(n % 1000, LocalPurchases.WrittenNumerics.FriendlyInteger(n / 1000, "", thousands + 1), 0)) : string.Concat(str, LocalPurchases.WrittenNumerics.FriendlyInteger(n % 100, string.Concat(LocalPurchases.WrittenNumerics.ones[n / 100], " Hundred"), 0)));
                }
                else
                {
                    str = string.Concat(str, LocalPurchases.WrittenNumerics.FriendlyInteger(n % 10, LocalPurchases.WrittenNumerics.tens[n / 10 - 2], 0));
                }
                return string.Concat(str, LocalPurchases.WrittenNumerics.thousandsGroups[thousands]);
            }
            ...
            public static string IntegerToWritten(int n)
            {
                ...
                if (n >= 0)
                {
                    return LocalPurchases.WrittenNumerics.FriendlyInteger(n, "", 0);
                }
                return string.Concat("Negative ", LocalPurchases.WrittenNumerics.IntegerToWritten(-n));
            }
        }
    }
}