<%@ page title="" theme="Theme1" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="Sale_Edit, App_Web_otqqrkum" %>
    ...
    <div class="container-fluid">
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center; font-size: 21px; font-weight: bold; height: 30px; padding-top: 0px">Sale Edit</div>
              ...
              <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
                 <div class="row" style=" background-color: #E0EBF5">
                    ...
                    <div class="row" style="margin-top: 1%">
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label4" Style="margin-left: 31%;" CssClass="present-address-lbl" runat="server" Text="Party Name:"/>
                                <asp:Label runat="server" ID="partyVDS" Visible="false" Text="false" />
                            </div>
                            <div class="col-sm-5" style="padding: 0px">
                                <asp:DropDownList ID="drpParty" runat="server" CssClass="present-address-tb" Style="width: 178px; height: 27px; text-align: left" AutoPostBack="True" OnSelectedIndexChanged="drpParty_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-2" style="padding: 0px">
                                <asp:Button ID="btnAddParty" runat="server" OnClick="btnAddParty_Click" Text="New" Style="width: 60px; height: 28px; margin-left: 4px;" />
                            </div>
                            <div class="col-sm-4" style="padding: 0px">
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label30" Style="margin-left: 36%;" CssClass="present-address-lbl"
                                    runat="server" Text="Challan No:"></asp:Label></div>
                            <div class="col-sm-9" style="padding: 0px">
                    ...
                    <div class="row" style="margin-top: 3px">
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label29" CssClass="present-address-lbl" Style="margin-left: 41%" runat="server"
                                    Text="Sale Type:"></asp:Label>
                            </div>
                            <div class="col-sm-9" style="padding: 0px">
                                <asp:DropDownList ID="drpSaleType" CssClass="present-address-tb" runat="server"
                        ...
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label31" CssClass="present-address-lbl" Style="margin-left: 4%" runat="server"
                    ...
                    <div class="row" style="margin-top: 3px">
                        ...
                        <div class="col-sm-4" style="padding: 0px">
                            ...
                            <div class="col-sm-9" style="padding: 0px">
                                <asp:DropDownList ID="drpVehicleType" CssClass="present-address-tb" runat="server"
                                    Style="width: 55%; height: 27px; margin-left: 4px; text-align: left">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label35" Style="margin-left: 37%" CssClass="present-address-lbl" runat="server"
                        ...
                        <div class="col-sm-4" style="padding: 0px">
                            <div class="col-sm-3" style="padding: 0px">
                                <asp:Label ID="Label23" CssClass="present-address-lbl" Style="margin-left: 44px" runat="server" Text="Remarks:" Visible="true"></asp:Label>
                            </div>
                            <div class="col-sm-9" style="padding: 0px">
                                <asp:TextBox ID="txtRemarks" CssClass="present-address-tb" runat="server" Style="width: 69%;height: 27px"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                <div class="row" style="margin-top:1%;padding-left:15px; padding-bottom:30px">
                           ...
                           <%-- <div class="test-label">
                            ...
                            <div class="test-label" style="margin-left:5px">
                                <asp:Label ID="lblSaleUnitPrice" runat="server" Text="Unit Price:" Style="margin-left: 0px;" Visible="true" /><br />
                                <asp:TextBox ID="txtSaleUnitPrice" CssClass="category" runat="server" AutoPostBack="True" Style="background-color: #D4FCFF"
                                    OnTextChanged="txtSaleUnitPrice_TextChanged" Visible="true" />
                               <%-- <asp:Label ID="lblSaleUnitPrice" runat="server" Text="" Style="margin-left: 0px;"
                                    Visible="false" />--%>
                            </div>
                            <div class="test-label">
                                <asp:Label ID="lblSaleVatablePrice" runat="server" Text="Vatable Price:" Style="margin-left: 0px;" Visible="true" /><br />
                                <asp:TextBox ID="txtSaleVatablePrice" CssClass="category" Style="background-color: #D4FCFF"
                                    runat="server" AutoPostBack="True" OnTextChanged="txtVatablePrice_TextChanged" Visible="true" />
                            </div>
                            <div class="test-label">
                                <asp:Label ID="lblSalesVat" runat="server" Text="VAT:" Style="margin-left: 0px;" Visible="true" /><br />
                                <asp:TextBox ID="txtSaleVat" CssClass="quantity" Style="background-color: #D4FCFF"
                                    runat="server" AutoPostBack="True" Visible="true"></asp:TextBox>
                                <asp:Label ID="lblSaleVat" runat="server" Text="" Visible="true" /><asp:Label ID="lblVatPercent" runat="server"
                                    Text="%" Visible="true"></asp:Label>
                            </div>
                            <div class="test-label">
                                <asp:Label ID="lblSalesSD" runat="server" Text="SD:" Style="margin-left: 0px;" Visible="true" /><br />
                                <asp:TextBox ID="txtSaleSD" CssClass="quantity" Style="background-color: #D4FCFF"
                                    runat="server" AutoPostBack="True" Visible="true"></asp:TextBox>
                                <asp:Label ID="lblSaleSD" runat="server" Text="" Visible="true"/><asp:Label ID="lblSDPercent" runat="server"
                                    Text="%" Visible="true"></asp:Label>
                            </div>
                            <div class="test-label">
                        ...
                        <div class="panel panel-primary" >
                            <div class="panel-body" >
                                <div class="" runat="server" id="gridviewPurchase" visible="true">
                                    <asp:GridView ID="gvSaleEdit" runat="server" AutoGenerateColumns="False" 
                                    OnSelectedIndexChanged="gvSale_SelectedIndexChanged" CssClass="sGrid" DataKeyNames="RowNo" Width="100%" ShowHeaderWhenEmpty="True">
                                        <Columns>
                                           <asp:CommandField ButtonType="Image" SelectImageUrl="~/Images/edit.png" ShowSelectButton="True" />
                                            ...
                                            <asp:BoundField HeaderText="Unit Price" DataField="SUnitPrice" />
                                            <asp:BoundField HeaderText="Vatable Price" DataField="SVatablePrice" />
                                            <asp:BoundField HeaderText="Vat" DataField="SVat" />
                                            <asp:BoundField HeaderText="SD" DataField="SSD" />
