<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="UI_Sale_Challan_Sale, App_Web_lqwzozjx" %>
    ...
    <table align="center" bgcolor="WhiteSmoke" border="0" cellpadding="0" cellspacing="3" class="brd_tbl_input" border="0px">
        <tr>
            <td class="page_title" colspan="4" align="center">
                Sales Challan (মূসক-১১)<uc1:sale ID="sale" runat="server" /></td>
        </tr>
        <tr>
            <td valign="top">
                &nbsp;</td>
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="Label8" runat="server" Text="Business Center Name :"></asp:Label>
            </td>
            <td>
            ...
            <td>
                <asp:Label ID="Label17" runat="server" Text="0001000"></asp:Label>
            </td>
        </tr>
        <tr>
            <td valign="top">
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="Label10" runat="server" Text="TIN :"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label13" runat="server" Text="0125789654235"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="Label3" runat="server" Text="Customer TIN :"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="input_field" colspan="3">
                <asp:TextBox ID="txtAddress" runat="server" Rows="1" TextMode="MultiLine" 
                    Width="410px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style1" valign="top">
                <asp:Label ID="Label28" runat="server" Text="Transport Type :"></asp:Label>
            </td>
            ...
            <td class="input_field">
                <asp:Label ID="Label27" runat="server" Text="Transport No :"></asp:Label>
            </td>
            <td class="input_field">
                <asp:TextBox ID="txtBankName0" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style1" valign="top">
