<%@ page title="" language="C#" masterpagefile="~/DashboardVTR.Master" autoeventwireup="true" inherits="UI_Item_ItemPriceDeclaration_1GHA, App_Web_ovuzd3bo" %>
    ...
    <table align="center" bgcolor="WhiteSmoke" border="0" cellpadding="0" 
        ...
        <tr>
            <td class="page_title" colspan="7" align="center">
                উপকরণ/উৎপাদন সম্পর্ক বা সহগ মূল্যভিত্তি ঘোষনাপত্র<uc1:ItemNav ID="ItemNav" runat="server" /></td>
        </tr>
        <tr>
                    ...
                    <table align="center" style="width:100%;margin:0px;padding:0px">
                        <tr>
                            ...
                            <fieldset>
                                ...
                                <div id="detailDivArea"  style="overflow: auto; border: 0px solid olive; width: 680px; height: 320px;" onscroll="Onscrollfnction();">
                            ...
                            ShowDeleteButton="True" />
                                         ...
                                         <asp:TemplateField HeaderText="অপচয়">
                                             ...
                                             <FooterStyle HorizontalAlign="Right" />
                                             <ItemTemplate>
                                                 <asp:TextBox ID="txtWastage" runat="server" CssClass="stdTextBox" Text="0.00" onblur="showTotalWastage(this)"
                            ...
                            <td valign="top">
                                <br />
                                <br />
                                <table align="left" cellpadding="0" cellspacing="0" class="brd_tbl_input">
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label ID="Label60" runat="server" CssClass="lebel_title" 
                                                Text="গায়ে/ধারকে/মোড়কে মুদ্রিত মূল্য"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtRetailPrice" runat="server" CssClass="text_box" 
                                                Width="100px">0.00</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label ID="Label65" runat="server" CssClass="lebel_title" 
                                                Text="উৎপাদন কারী কর্তৃক নির্ধারিত মূসক আরোপযোগ্য মূল্য"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtProposedVATPrice" runat="server" CssClass="text_box" 
                                                Width="100px">0.00</asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
