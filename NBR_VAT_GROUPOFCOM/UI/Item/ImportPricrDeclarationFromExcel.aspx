<%@ page language="C#" autoeventwireup="true" masterpagefile="~/DashboardVTR.Master" inherits="UI_Item_ImportPricrDeclarationFromExcel, App_Web_ovuzd3bo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row">
        <div class="panel panel-primary">
                ...
                <div class="container-fluid">
                    <div>Value Addition</div>
                     <div class="gridDiv table-responsive paddingsmall" runat="server">
                              ...
                              <div class="wrapper2">
                                   <div class="div2">
                                 <asp:GridView ID="gvValuaddition"  runat="server" AutoGenerateColumns="false" CellPadding="4" Width="100%"
                                      OnRowDataBound="gvValuaddition_RowDataBound" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" BorderStyle="None">
                                     <Columns>
            ...
            <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px">
                <div class="container-fluid">
                     <div>Other Principal Inputs</div>
                     <div class="gridDiv table-responsive paddingsmall" runat="server">
                              <div class="wrapper1">
                                    <div class="div1"></div>
                                 </div>
                              <div class="wrapper2">
                                   <div class="div2">
                                 <asp:GridView ID="gvOtherInput"  runat="server" AutoGenerateColumns="false" CellPadding="4" Width="100%"
                                OnRowDataBound="gvOtherInput_RowDataBound" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" BorderStyle="None">
                                     <Columns>
