...
<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="SetItems.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Item.SetItems" enableeventvalidation="false" %>
     ...
     <div class="modal-content">
      ...
      <table class="brd_tbl_input" style="border-color: #4CAF50; border-width: medium;">
        ...
        <table class="brd_tbl_input"  
          ...
          <%--      <uc2:MsgBoxs runat="server" ID="MsgBoxs"  style="margin-top:510%" />--%>

                <uc2:MsgBoxs runat="server" ID="MsgBoxs" />
