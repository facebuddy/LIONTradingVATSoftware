<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardVTR.Master" AutoEventWireup="true" CodeBehind="ItemOpeningInfo.aspx.cs" Inherits="NBR_VAT_GROUPOFCOM.UI.Item.ItemOpeningInfo" %>
...
<%@ Register Src="~/UserControls/Items.ascx" TagPrefix="uc2" TagName="Items" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                ...
                <div class="col-sm-7" style="border: 1px solid gray">
                    <div class="page_title">
                      ...
                      <%--  <uc1:ItemNav ID="ItemNav" runat="server" />--%>
                        ...
                        <uc2:Items runat="server" id="ItemNav" />
                    </div>
    ...
    <asp:Button ID="btnCatClear" runat="server" Text="Close" CssClass="btn btn-danger" /><br />
      ...
      <%--      <ajaxToolkit:ModalPopupExtender ID="modalPopupForAddCategory" runat="server"
            ...
            <ajaxToolkit:ModalPopupExtender ID="modalPopupForAddCategory"   PopupControlID="pnAddCategory"
                TargetControlID="btnHiddenForAddCategory" BackgroundCssClass="mpBack" runat="server"></ajaxToolkit:ModalPopupExtender>
